...
/**\brief Minimum specified output voltage VCP vs VSD for low VSD, with ADC2 type 2 attenuator tolerance (+/-400mV) */
#define BDRV_MINCPVOLT_LOWVSD (7600u)
/**\brief Minimum specified output voltage VCP vs VSD for normal or high VSD, with ADC2 type 2 attenuator tolerance (+/-400mV) */
...
sint8 BDRV_setBridge(tBDRV_chCfg e_ls1Cfg, tBDRV_chCfg e_hs1Cfg, tBDRV_chCfg e_ls2Cfg, tBDRV_chCfg e_hs2Cfg) {
  ...
  if((e_ls1Cfg >= BDRV_chCfg_off) && (e_ls1Cfg <= BDRV_chCfg_on) && (e_hs1Cfg >= BDRV_chCfg_off) && (e_hs1Cfg <= BDRV_chCfg_hsDcs) && (e_ls2Cfg >= BDRV_chCfg_off) && (e_ls2Cfg <= BDRV_chCfg_on) &&
     (e_hs2Cfg >= BDRV_chCfg_off) && (e_hs2Cfg <= BDRV_chCfg_hsDcs)) {
    /* Side 1 */
...
sint8 BDRV_setLSChrgSeqMode(tBDRV_hb e_hb, tBDRV_seqCfg s_seqChrgCfg) {
  ...
  /* Violation: Relational operator '<=' always evaluates to 'true' [MISRA 2012 Rule 14.3, required] */
  if((s_seqChrgCfg.e_seqPhase1CurrentAct <= BDRV_currentCfg_350mA) && (s_seqChrgCfg.e_seqPhase2CurrentAct <= BDRV_currentCfg_350mA) && (s_seqChrgCfg.e_seqPhase3CurrentAct <= BDRV_currentCfg_350mA) &&
     (s_seqChrgCfg.e_seqPhase4CurrentAct <= BDRV_currentCfg_350mA) && (s_seqChrgCfg.u16_seqPhase1TimeAct_ns >= (uint16)50) && (s_seqChrgCfg.u16_seqPhase1TimeAct_ns <= (uint16)3200) &&
     (s_seqChrgCfg.u16_seqPhase2TimeAct_ns >= (uint16)50) && (s_seqChrgCfg.u16_seqPhase2TimeAct_ns <= (uint16)3200) && (s_seqChrgCfg.u16_seqPhase3TimeAct_ns >= (uint16)50) &&
     (s_seqChrgCfg.u16_seqPhase3TimeAct_ns <= (uint16)3200) && (s_seqChrgCfg.u16_seqPhase4TimeAct_ns >= (uint16)50) && (s_seqChrgCfg.u16_seqPhase4TimeAct_ns <= (uint16)3200) &&
     (s_seqChrgCfg.e_constCurrentFW <= BDRV_currentCfg_350mA) && (s_seqChrgCfg.u16_constTimeFW_ns >= (uint16)50) && (s_seqChrgCfg.u16_constTimeFW_ns <= (uint16)12800)) {
    switch(e_hb) {
    case BDRV_hb_1: {
...
sint8 BDRV_setLSDischrgSeqMode(tBDRV_hb e_hb, tBDRV_seqCfg s_seqDischrgCfg) {
  ...
  /* Violation: Relational operator '<=' always evaluates to 'true' [MISRA 2012 Rule 14.3, required] */
  if((s_seqDischrgCfg.e_seqPhase1CurrentAct <= BDRV_currentCfg_350mA) && (s_seqDischrgCfg.e_seqPhase2CurrentAct <= BDRV_currentCfg_350mA) &&
     (s_seqDischrgCfg.e_seqPhase3CurrentAct <= BDRV_currentCfg_350mA) && (s_seqDischrgCfg.u16_seqPhase1TimeAct_ns >= (uint16)50) && (s_seqDischrgCfg.u16_seqPhase1TimeAct_ns <= (uint16)3200) &&
     (s_seqDischrgCfg.u16_seqPhase2TimeAct_ns >= (uint16)50) && (s_seqDischrgCfg.u16_seqPhase2TimeAct_ns <= (uint16)3200) && (s_seqDischrgCfg.u16_seqPhase3TimeAct_ns >= (uint16)50) &&
     (s_seqDischrgCfg.u16_seqPhase3TimeAct_ns <= (uint16)3200) && (s_seqDischrgCfg.e_constCurrentFW <= BDRV_currentCfg_350mA) && (s_seqDischrgCfg.u16_constTimeFW_ns >= (uint16)50) &&
...
sint8 BDRV_setChrgAdaptSeqMode(tBDRV_aseqCfg s_aseqChrgCfg) {
  ...
  /* Violation: Relational operator '<=' always evaluates to 'true' [MISRA 2012 Rule 14.3, required] */
  if((s_aseqChrgCfg.e_aseqMinCurrent <= BDRV_currentCfg_350mA) && (s_aseqChrgCfg.e_aseqMaxCurrent <= BDRV_currentCfg_350mA) && (s_aseqChrgCfg.u16_aseqMinTime_ns >= (uint16)50) &&
     (s_aseqChrgCfg.u16_aseqMinTime_ns <= (uint16)12800) && (s_aseqChrgCfg.u16_aseqMaxTime_ns >= (uint16)50) && (s_aseqChrgCfg.u16_aseqMaxTime_ns <= (uint16)12800)) {
...
sint8 BDRV_setDischrgAdaptSeqMode(tBDRV_aseqCfg s_aseqDischrgCfg) {
  ...
  /* Violation: Relational operator '<=' always evaluates to 'true' [MISRA 2012 Rule 14.3, required] */
  if((s_aseqDischrgCfg.e_aseqMinCurrent <= BDRV_currentCfg_350mA) && (s_aseqDischrgCfg.e_aseqMaxCurrent <= BDRV_currentCfg_350mA) && (s_aseqDischrgCfg.u16_aseqMinTime_ns >= (uint16)50) &&
     (s_aseqDischrgCfg.u16_aseqMinTime_ns <= (uint16)12800) && (s_aseqDischrgCfg.u16_aseqMaxTime_ns >= (uint16)50) && (s_aseqDischrgCfg.u16_aseqMaxTime_ns <= (uint16)12800)) {
