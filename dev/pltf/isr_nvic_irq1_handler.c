...
/* Check if NVIC node 1 is enabled */
#if((CPU_NVIC_ISER & CPU_NVIC_ISER_IRQEN1_Msk) == (1u << CPU_NVIC_ISER_IRQEN1_Pos))
...
#if(NVIC_IRQ1_HANDLER_INT_CHECK == 1)
  u8_interrupt_cnt_irq1 = 0;
#endif
  /* Bus dominant timeout */
#if(CANTRX_BUS_TO_INT_EN == 1)
#if(((SCU_INP0 & SCU_INP0_INP_CANTX_Msk) >> SCU_INP0_INP_CANTX_Pos) == WARN_INP_NVIC_IRQ1)
...
#if(((SCU_INP0 & SCU_INP0_INP_BDRV_IRQ1_Msk) >> SCU_INP0_INP_BDRV_IRQ1_Pos) == WARN_INP_NVIC_IRQ1)
...
#if(((SCU_INP0 & SCU_INP0_INP_BDRV_IRQ0_Msk) >> SCU_INP0_INP_BDRV_IRQ0_Pos) == WARN_INP_NVIC_IRQ1)
...
#if(((SCU_INP0 & SCU_INP0_INP_CSC_Msk) >> SCU_INP0_INP_CSC_Pos) == WARN_INP_NVIC_IRQ1)
...
#if(((SCU_INP0 & SCU_INP0_INP_PMU_Msk) >> SCU_INP0_INP_PMU_Pos) == WARN_INP_NVIC_IRQ1)
...
#if(((SCU_INP0 & SCU_INP0_INP_ARVG_Msk) >> SCU_INP0_INP_ARVG_Pos) == WARN_INP_NVIC_IRQ1)
...
#endif /* ((CPU_NVIC_ISER & CPU_NVIC_ISER_IRQEN1_Msk) == 1u) */
