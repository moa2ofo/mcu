...
#if((CPU_NVIC_ISER & CPU_NVIC_ISER_IRQEN5_Msk) == (1u << CPU_NVIC_ISER_IRQEN5_Pos))
...
void NVIC_IRQ5_Handler(void) {
...
#if(((CCU7_INP & CCU7_INP_INPT12_Msk) >> CCU7_INP_INPT12_Pos) == CCU7_INP_NVIC_IRQ5)
...
#if(((CCU7_INP & CCU7_INP_INPT13_Msk) >> CCU7_INP_INPT13_Pos) == CCU7_INP_NVIC_IRQ5)
...
#if(((CCU7_INP_2 & CCU7_INP_2_INPT14_Msk) >> CCU7_INP_2_INPT14_Pos) == CCU7_INP_NVIC_IRQ5)
...
#if(((CCU7_INP_2 & CCU7_INP_2_INPT15_Msk) >> CCU7_INP_2_INPT15_Pos) == CCU7_INP_NVIC_IRQ5)
...
#if(((CCU7_INP_2 & CCU7_INP_2_INPT16_Msk) >> CCU7_INP_2_INPT16_Pos) == CCU7_INP_NVIC_IRQ5)
...
#if(((CCU7_INP & CCU7_INP_INPCC70_Msk) >> CCU7_INP_INPCC70_Pos) == CCU7_INP_NVIC_IRQ5)
...
#if(((CCU7_INP & CCU7_INP_INPCC71_Msk) >> CCU7_INP_INPCC71_Pos) == CCU7_INP_NVIC_IRQ5)
  ...
  /* C72A CCM R */
#if(CCU7_CC71A_CM_R_INT_EN == 1)
#if(((CCU7_INP & CCU7_INP_INPCC72_Msk) >> CCU7_INP_INPCC72_Pos) == CCU7_INP_NVIC_IRQ5)
...
#if(((CCU7_INP_2 & CCU7_INP_2_INPCC70B_Msk) >> CCU7_INP_2_INPCC70B_Pos) == CCU7_INP_NVIC_IRQ5)
...
#if(((CCU7_INP_2 & CCU7_INP_2_INPCC71B_Msk) >> CCU7_INP_2_INPCC71B_Pos) == CCU7_INP_NVIC_IRQ5)
...
#if(((CCU7_INP_2 & CCU7_INP_2_INPCC72B_Msk) >> CCU7_INP_2_INPCC72B_Pos) == CCU7_INP_NVIC_IRQ5)
...
#if(((CCU7_INP & CCU7_INP_INPERR_Msk) >> CCU7_INP_INPERR_Pos) == CCU7_INP_NVIC_IRQ5)
...
#if(((CCU7_INP & CCU7_INP_INPCHE_Msk) >> CCU7_INP_INPCHE_Pos) == CCU7_INP_NVIC_IRQ5)
  ...
  /* Lost Bit Event */
#if(CCU7_LI_INT_EN == 1)
#if(((CCU7_LI & CCU7_LI_INPLBE_Msk) >> CCU7_LI_INPLBE_Pos) == CCU7_INP_NVIC_IRQ5)
...
#endif /* ((CPU_NVIC_ISER & CPU_NVIC_ISER_IRQEN5_Msk) == 1u) */
