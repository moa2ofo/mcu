#<checksum>2b8b933d285bc474ee70dcf42fd41cd4afde5b29548109d2bf96f0e8e26f575e</checksum>
#                                                                                
...
#  V0.1.2: 2023-03-14, BG:   EP-1410: Added condition to check range only for #
#                            the Advanced configuration                       #
#  V0.1.3: 2024-11-05, JO:   EP-1494: Updated license                         #
###############################################################################
...
def check_range(name, test_val, min, max):
  # check range only for the Advanced configuration
  if SCU_CLK_CONFIG_EDIT.text == "1":
