...
/**
 * \file     startup_tle989x.c
 *
 * \brief    startup file (c) for TLE988x/TLE989x
 *
 * \version  V0.1.5
 * \date     05. Nov 2024
 *
...
********************************************************************************
** V0.1.0: 2022-08-18, JO:   EP-1235: Initial version of startup file in C    **
** V0.1.1: 2023-05-15, PS:   EP-1441: Update c startup file and linker file   **
**                                    for IAR to use sections                 **
** V0.1.2: 2023-08-10, VO:   EP-1464: Put debug_entry also in deprecated VTOR **
**                                    Fixed location of ER_NVM0_DEBUG_CONNECT **
**                                    in sct files                            **
** V0.1.3: 2023-11-29, VO:   EP-1465: Added chache enable to reset handler    **
** V0.1.4: 2024-05-06, VO:   EP-1510: Removed 'Todo' comments                 **
** V0.1.5: 2024-11-05, JO:   EP-1494: Updated license                         **
*******************************************************************************/

/* Work instructions:
   When using this startup file, the project needs a linker script.
   The linker script is has already been copied to the
   RTE/Device/--devicename-- folder of this project and
   needs to be added to the project manually.
   Keil:
   'Options for target'
   --> 'Linker' tab
   --> uncheck 'Use Memory Layout from Rarget Dialog'
   --> Scatter file: '...'
   --> add the linker file mentioned above (tle9881_91.sct or tle9883_93.sct)
*/
