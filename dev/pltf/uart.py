#<checksum>4b4d3d80d35d4a611a524e580f0dc60bc64c26b7cd15f10f658182f9ab502c74</checksum>
#
...
#  V0.1.3: 2022-05-02, JO:   EP-996: Corrected behavior in case of CLK update #
#  V0.1.4: 2024-11-05, JO:   EP-1494: Updated license                         #
###############################################################################
...
# Frequency
UART_FREQ_SPIN.connect('valueChanged(int)', updateBaudrateUART0_connect)
UART_FREQ_SPIN.connect('valueChanged(int)', updateBaudrateUART1_connect)
