# 0 "utExecutionAndResults/utUnderTest/src/pmu.h"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "utExecutionAndResults/utUnderTest/src/pmu.h"
# 134 "utExecutionAndResults/utUnderTest/src/pmu.h"
...
# 135 "utExecutionAndResults/utUnderTest/src/pmu.h" 2

# 1 "utExecutionAndResults/utUnderTest/src/pmu_defines.h" 1
# 137 "utExecutionAndResults/utUnderTest/src/pmu.h" 2
...
# 138 "utExecutionAndResults/utUnderTest/src/pmu.h" 2
# 1 "utExecutionAndResults/utUnderTest/src/scu_defines.h" 1
# 139 "utExecutionAndResults/utUnderTest/src/pmu.h" 2
# 198 "utExecutionAndResults/utUnderTest/src/pmu.h"
...
static inline void PMU_enVDDPUndervoltageWarnInt(void);
static inline void PMU_enVDDPOvervoltageInt(void);
static inline void PMU_disVDDPUndervoltageWarnInt(void);
static inline void PMU_disVDDPOvervoltageInt(void);
static inline uint8 PMU_getVDDPUndervoltageWarnIntSts(void);
static inline uint8 PMU_getVDDPOvervoltageIntSts(void);
static inline uint8 PMU_getVDDPUndervoltageWarnSts(void);
static inline uint8 PMU_getVDDPCurrentLimitSts(void);
static inline uint8 PMU_getVDDPHighCurrentModeSts(void);
static inline void PMU_clrVDDPUndervoltageWarnIntSts(void);
static inline void PMU_clrVDDPOvervoltageIntSts(void);
static inline void PMU_clrVDDPUndervoltageWarnSts(void);
static inline void PMU_clrVDDPCurrentLimitSts(void);
static inline void PMU_clrVDDPHighCurrentModeSts(void);
static inline void PMU_enVDDCUndervoltageWarnInt(void);
static inline void PMU_enVDDCOvervoltageInt(void);
static inline void PMU_disVDDCUndervoltageWarnInt(void);
static inline void PMU_disVDDCOvervoltageInt(void);
static inline uint8 PMU_getVDDCUndervoltageWarnIntSts(void);
static inline uint8 PMU_getVDDCOvervoltageIntSts(void);
static inline uint8 PMU_getVDDCUndervoltageWarnSts(void);
static inline uint8 PMU_getVDDCHighCurrentModeSts(void);
static inline void PMU_clrVDDCUndervoltageWarnIntSts(void);
static inline void PMU_clrVDDCOvervoltageIntSts(void);
static inline void PMU_clrVDDCUndervoltageWarnSts(void);
static inline void PMU_clrVDDCHighCurrentModeSts(void);
static inline void PMU_enVDDEXTUndervoltageInt(void);
static inline void PMU_enVDDEXTOvertemperatureInt(void);
static inline void PMU_disVDDEXTUndervoltageInt(void);
static inline void PMU_disVDDEXTOvertemperatureInt(void);
static inline uint8 PMU_getVDDEXTUndervoltageIntSts(void);
static inline uint8 PMU_getVDDEXTOvertemperatureIntSts(void);
static inline uint8 PMU_getVDDEXTUndervoltageSts(void);
static inline uint8 PMU_getVDDEXTOvertemperatureSts(void);
static inline void PMU_clrVDDEXTUndervoltageIntSts(void);
static inline void PMU_clrVDDEXTOvertemperatureIntSts(void);
static inline void PMU_clrVDDEXTUndervoltageSts(void);
static inline void PMU_clrVDDEXTOvertemperatureSts(void);
static inline uint8 PMU_getVDDPRegulatorTimeoutSts(void);
static inline uint8 PMU_getVDDCRegulatorTimeoutSts(void);
static inline uint8 PMU_getHPClkFailSts(void);
static inline uint8 PMU_getSysOvertemperatureSts(void);
static inline uint8 PMU_getSeqWdFailSts(void);
static inline uint8 PMU_getVDDPRegulatorOvertemperatureSts(void);
static inline uint8 PMU_getVDDCOvercurrentSts(void);
static inline void PMU_clrVDDPRegulatorTimeoutSts(void);
static inline void PMU_clrVDDCRegulatorTimeoutSts(void);
static inline void PMU_clrHPClkFailSts(void);
static inline void PMU_clrSysOvertemperatureSts(void);
static inline void PMU_clrSeqWdFailSts(void);
static inline void PMU_clrVDDPRegulatorOvertemperatureSts(void);
static inline void PMU_clrVDDCOvercurrentSts(void);
static inline uint8 PMU_getMstrSupplyUndervoltageRstSts(void);
static inline uint8 PMU_getMstrClkWDRstSts(void);
static inline uint8 PMU_getFailSleepExitRstSts(void);
static inline uint8 PMU_getSleepExitRstSts(void);
static inline uint8 PMU_getStopExitRstSts(void);
static inline uint8 PMU_getPinRstSts(void);
static inline uint8 PMU_getFailSafeWDRstSts(void);
static inline uint8 PMU_getWDTimerRstSts(void);
static inline uint8 PMU_getSoftRstSts(void);
static inline uint8 PMU_getLockupRstSts(void);
static inline uint8 PMU_getVDDPUndervoltageRstSts(void);
static inline uint8 PMU_getVDDCUndervoltageRstSts(void);
static inline uint8 PMU_getSecureStackOverflowRstSts(void);
static inline void PMU_clrMstrSupplyUndervoltageRstSts(void);
static inline void PMU_clrMstrClkWDRstSts(void);
static inline void PMU_clrFailSleepExitRstSts(void);
static inline void PMU_clrSleepExitRstSts(void);
static inline void PMU_clrStopExitRstSts(void);
static inline void PMU_clrPinRstSts(void);
static inline void PMU_clrFailSafeWDRstSts(void);
static inline void PMU_clrWDTimerRstSts(void);
static inline void PMU_clrSoftRstSts(void);
static inline void PMU_clrLockupRstSts(void);
static inline void PMU_clrVDDPUndervoltageRstSts(void);
static inline void PMU_clrVDDCUndervoltageRstSts(void);
static inline void PMU_clrSecureStackOverflowRstSts(void);
static inline sint8 PMU_enWakeupSrc(uint32 u32_wakeupSrc);
static inline sint8 PMU_disWakeupSrc(uint32 u32_wakeupSrc);
static inline uint32 PMU_getWakeupSrc(void);
static inline void PMU_enStopModeVDDCReduct(void);
static inline void PMU_disStopModeVDDCReduct(void);
static inline sint8 PMU_setGPIOWakeCfg(uint8 u8_GPIO, uint8 u8_enRisingEdge, uint8 u8_enFallingEdge, uint8 u8_enCycSen, tPMU_gpioInput e_gpioInput);
static inline sint8 PMU_setMONWakeCfg(uint8 u8_MON, uint8 u8_enRisingEdge, uint8 u8_enFallingEdge, uint8 u8_enCycSen, uint8 u8_enPullupCurrSrc, uint8 u8_enPulldownCurrSrc);
static inline uint8 PMU_getMON1InputSts(void);
static inline uint8 PMU_getMON2InputSts(void);
static inline uint8 PMU_getMON3InputSts(void);
static inline uint8 PMU_getCANWakeSts(void);
static inline uint8 PMU_getCyclicWakeSts(void);
static inline uint8 PMU_getGPIO0WakeSts(void);
static inline uint8 PMU_getGPIO1WakeSts(void);
static inline uint8 PMU_getGPIO2WakeSts(void);
static inline uint8 PMU_getGPIO3WakeSts(void);
static inline uint8 PMU_getGPIO4WakeSts(void);
static inline uint8 PMU_getGPIO5WakeSts(void);
static inline uint8 PMU_getMON1WakeSts(void);
static inline uint8 PMU_getMON2WakeSts(void);
static inline uint8 PMU_getMON3WakeSts(void);
static inline uint8 PMU_getVDDPUndervoltageWarnWakeSts(void);
static inline uint8 PMU_getVDDPOvervoltageWakeSts(void);
static inline uint8 PMU_getVDDPHighCurrentModeWakeSts(void);
static inline uint8 PMU_getVDDCUndervoltageWarnWakeSts(void);
static inline uint8 PMU_getVDDCOvervoltageWakeSts(void);
static inline uint8 PMU_getVDDCHighCurrentModeWakeSts(void);
static inline uint8 PMU_getVDDEXTOvertemperatureWakeSts(void);
static inline uint8 PMU_getVDDEXTUndervoltageWakeSts(void);
static inline uint8 PMU_getVSDOvervoltageWakeSts(void);
static inline void PMU_clrCANWakeSts(void);
static inline void PMU_clrCyclicWakeSts(void);
static inline void PMU_clrGPIO0WakeSts(void);
static inline void PMU_clrGPIO1WakeSts(void);
static inline void PMU_clrGPIO2WakeSts(void);
static inline void PMU_clrGPIO3WakeSts(void);
static inline void PMU_clrGPIO4WakeSts(void);
static inline void PMU_clrGPIO5WakeSts(void);
static inline void PMU_clrMON1WakeSts(void);
static inline void PMU_clrMON2WakeSts(void);
static inline void PMU_clrMON3WakeSts(void);
static inline void PMU_clrVDDPUndervoltageWarnWakeSts(void);
static inline void PMU_clrVDDPOvervoltageWakeSts(void);
static inline void PMU_clrVDDPHighCurrentModeWakeSts(void);
static inline void PMU_clrVDDCUndervoltageWarnWakeSts(void);
static inline void PMU_clrVDDCOvervoltageWakeSts(void);
static inline void PMU_clrVDDCHighCurrentModeWakeSts(void);
static inline void PMU_clrVDDEXTOvertemperatureWakeSts(void);
static inline void PMU_clrVDDEXTUndervoltageWakeSts(void);
static inline void PMU_clrVSDOvervoltageWakeSts(void);
static inline void PMU_enFailInputPullUp(void);
static inline void PMU_enResetPin(void);
static inline void PMU_disFailInputPullUp(void);
static inline void PMU_disResetPin(void);
static inline uint8 PMU_getMstrClkWDFailSts(void);
static inline uint8 PMU_getMstrSupplyUndervoltageSts(void);
static inline uint8 PMU_getMstrSupplyOvervoltageSts(void);
static inline uint8 PMU_getWDFailSts(void);
static inline uint8 PMU_getWDSelfTestFailSts(void);
static inline uint8 PMU_getVDDCUndervoltageSts(void);
static inline uint8 PMU_getVDDCOvervoltageSts(void);
static inline uint8 PMU_getVDDPUndervoltageSts(void);
static inline uint8 PMU_getVDDPOvervoltageSts(void);
static inline uint8 PMU_getVDDPOvertemperatureSts(void);
static inline uint8 PMU_getVAREFOvervoltageSts(void);
static inline uint8 PMU_getCSCOvercurrentSts(void);
static inline uint8 PMU_getCSCSelfTestFailSts(void);
static inline uint8 PMU_getCSCEnFailSts(void);
static inline uint8 PMU_getPinMonitorFailSts(void);
static inline uint8 PMU_getFOOvercurrentSts(void);
static inline void PMU_clrMstrClkWDFailSts(void);
static inline void PMU_clrMstrSupplyUndervoltageSts(void);
static inline void PMU_clrMstrSupplyOvervoltageSts(void);
static inline void PMU_clrWDFailSts(void);
static inline void PMU_clrWDSelfTestFailSts(void);
static inline void PMU_clrVDDCUndervoltageSts(void);
static inline void PMU_clrVDDCOvervoltageSts(void);
static inline void PMU_clrVDDPUndervoltageSts(void);
static inline void PMU_clrVDDPOvervoltageSts(void);
static inline void PMU_clrVDDPOvertemperatureSts(void);
static inline void PMU_clrVAREFOvervoltageSts(void);
static inline void PMU_clrCSCOvercurrentSts(void);
static inline void PMU_clrCSCSelfTestFailSts(void);
static inline void PMU_clrCSCEnFailSts(void);
static inline void PMU_clrPinMonitorFailSts(void);
static inline void PMU_clrFOOvercurrentSts(void);
static inline uint8 PMU_getSafeShutdownSts(void);
static inline uint8 PMU_getFailOutputSts(void);
static inline void PMU_clrSafeShutdownSts(void);
static inline void PMU_clrFailOutputSts(void);
# 414 "utExecutionAndResults/utUnderTest/src/pmu.h"
...
static inline void PMU_clrVDDEXTOver