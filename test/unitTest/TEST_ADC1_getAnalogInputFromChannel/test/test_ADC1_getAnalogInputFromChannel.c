/**
    * @file test/unitTest/TEST_ADC1_getAnalogInputFromChannel/test/test_ADC1_getAnalogInputFromChannel.c
    * @brief Unit tests for ADC1_getAnalogInputFromChannel.
    *
    * @anchor UT_ADC1_getAnalogInputFromChannel
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_getAnalogInputFromChannel.
    */
    
#include "ADC1_getAnalogInputFromChannel.h"
#include "unity.h"
...
void test_ADC1_getAnalogInputFromChannel(void)
{
