/**
    * @file test/unitTest/TEST_ADC1_getCalibEnFromChannel/test/test_ADC1_getCalibEnFromChannel.c
    * @brief Unit tests for ADC1_getCalibEnFromChannel.
    *
    * @anchor UT_ADC1_getCalibEnFromChannel
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_getCalibEnFromChannel.
    */
    
#include "ADC1_getCalibEnFromChannel.h"
#include "unity.h"
...
void test_ADC1_getCalibEnFromChannel(void)
{
