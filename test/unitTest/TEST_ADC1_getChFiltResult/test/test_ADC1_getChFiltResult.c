/**
    * @file test/unitTest/TEST_ADC1_getChFiltResult/test/test_ADC1_getChFiltResult.c
    * @brief Unit tests for ADC1_getChFiltResult.
    *
    * @anchor UT_ADC1_getChFiltResult
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_getChFiltResult.
    */
    
#include "ADC1_getChFiltResult.h"
#include "unity.h"
...
void test_ADC1_getChFiltResult(void)
{
