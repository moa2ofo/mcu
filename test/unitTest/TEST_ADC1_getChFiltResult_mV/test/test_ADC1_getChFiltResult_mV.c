/**
    * @file test/unitTest/TEST_ADC1_getChFiltResult_mV/test/test_ADC1_getChFiltResult_mV.c
    * @brief Unit tests for ADC1_getChFiltResult_mV.
    *
    * @anchor UT_ADC1_getChFiltResult_mV
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_getChFiltResult_mV.
    */
...
void test_ADC1_getChFiltResult_mV(void)
{
