/**
    * @file test/unitTest/TEST_ADC1_getChResult/test/test_ADC1_getChResult.c
    * @brief Unit tests for ADC1_getChResult.
    *
    * @anchor UT_ADC1_getChResult
    *
    * @details
...
void test_ADC1_getChResult(void)
{
