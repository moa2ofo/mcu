/**
    * @file test/unitTest/TEST_ADC1_getChResult_mV/test/test_ADC1_getChResult_mV.c
    * @brief Unit tests for ADC1_getChResult_mV.
    *
    * @anchor UT_ADC1_getChResult_mV
    *
    * @details
...
void test_ADC1_getChResult_mV(void)
{
