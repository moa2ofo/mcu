/**
    * @file test/unitTest/TEST_ADC1_getEndOfConvSts/test/test_ADC1_getEndOfConvSts.c
    * @brief Unit tests for ADC1_getEndOfConvSts.
    *
    * @anchor UT_ADC1_getEndOfConvSts
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_getEndOfConvSts.
    */
    
#include "ADC1_getEndOfConvSts.h"
#include "unity.h"
...
void test_ADC1_getEndOfConvSts(void)
{
