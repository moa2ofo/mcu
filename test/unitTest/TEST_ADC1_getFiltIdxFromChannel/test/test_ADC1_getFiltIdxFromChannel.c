/**
    * @file test/unitTest/TEST_ADC1_getFiltIdxFromChannel/test/test_ADC1_getFiltIdxFromChannel.c
    * @brief Unit tests for ADC1_getFiltIdxFromChannel.
    *
    * @anchor UT_ADC1_getFiltIdxFromChannel
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_getFiltIdxFromChannel.
    */
    
#include "ADC1_getFiltIdxFromChannel.h"
#include "unity.h"
...
void test_ADC1_getFiltIdxFromChannel(void)
{
