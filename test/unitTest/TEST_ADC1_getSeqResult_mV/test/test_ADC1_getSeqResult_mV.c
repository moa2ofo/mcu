/**
    * @file test/unitTest/TEST_ADC1_getSeqResult_mV/test/test_ADC1_getSeqResult_mV.c
    * @brief Unit tests for ADC1_getSeqResult_mV.
    *
    * @anchor UT_ADC1_getSeqResult_mV
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_getSeqResult_mV.
    */
    
#include "ADC1_getSeqResult_mV.h"
#include "unity.h"
...
void test_ADC1_getSeqResult_mV(void)
{
