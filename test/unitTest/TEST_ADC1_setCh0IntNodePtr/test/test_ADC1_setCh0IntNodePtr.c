/**
    * @file test/unitTest/TEST_ADC1_setCh0IntNodePtr/test/test_ADC1_setCh0IntNodePtr.c
    * @brief Unit tests for ADC1_setCh0IntNodePtr.
    *
    * @anchor UT_ADC1_setCh0IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh0IntNodePtr.
    */
    
#include "ADC1_setCh0IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh0IntNodePtr(void)
{
