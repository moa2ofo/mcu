/**
    * @file test/unitTest/TEST_ADC1_setCh10IntNodePtr/test/test_ADC1_setCh10IntNodePtr.c
    * @brief Unit tests for ADC1_setCh10IntNodePtr.
    *
    * @anchor UT_ADC1_setCh10IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh10IntNodePtr.
    */
    
#include "ADC1_setCh10IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh10IntNodePtr(void)
{
