/**
    * @file test/unitTest/TEST_ADC1_setCh11IntNodePtr/test/test_ADC1_setCh11IntNodePtr.c
    * @brief Unit tests for ADC1_setCh11IntNodePtr.
    *
    * @anchor UT_ADC1_setCh11IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh11IntNodePtr.
    */
    
#include "ADC1_setCh11IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh11IntNodePtr(void)
{
