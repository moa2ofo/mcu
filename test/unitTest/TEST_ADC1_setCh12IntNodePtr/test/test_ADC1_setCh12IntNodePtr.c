/**
    * @file test/unitTest/TEST_ADC1_setCh12IntNodePtr/test/test_ADC1_setCh12IntNodePtr.c
    * @brief Unit tests for ADC1_setCh12IntNodePtr.
    *
    * @anchor UT_ADC1_setCh12IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh12IntNodePtr.
    */
    
#include "ADC1_setCh12IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh12IntNodePtr(void)
{
