/**
    * @file test/unitTest/TEST_ADC1_setCh13IntNodePtr/test/test_ADC1_setCh13IntNodePtr.c
    * @brief Unit tests for ADC1_setCh13IntNodePtr.
    *
    * @anchor UT_ADC1_setCh13IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh13IntNodePtr.
    */
    
#include "ADC1_setCh13IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh13IntNodePtr(void)
{
