/**
    * @file test/unitTest/TEST_ADC1_setCh14IntNodePtr/test/test_ADC1_setCh14IntNodePtr.c
    * @brief Unit tests for ADC1_setCh14IntNodePtr.
    *
    * @anchor UT_ADC1_setCh14IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh14IntNodePtr.
    */
    
#include "ADC1_setCh14IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh14IntNodePtr(void)
{
