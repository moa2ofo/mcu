/**
    * @file test/unitTest/TEST_ADC1_setCh15IntNodePtr/test/test_ADC1_setCh15IntNodePtr.c
    * @brief Unit tests for ADC1_setCh15IntNodePtr.
    *
    * @anchor UT_ADC1_setCh15IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh15IntNodePtr.
    */
    
#include "ADC1_setCh15IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh15IntNodePtr(void)
{
