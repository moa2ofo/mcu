/**
    * @file test/unitTest/TEST_ADC1_setCh16IntNodePtr/test/test_ADC1_setCh16IntNodePtr.c
    * @brief Unit tests for ADC1_setCh16IntNodePtr.
    *
    * @anchor UT_ADC1_setCh16IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh16IntNodePtr.
    */
    
#include "ADC1_setCh16IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh16IntNodePtr(void)
{
