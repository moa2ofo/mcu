/**
    * @file test/unitTest/TEST_ADC1_setCh17IntNodePtr/test/test_ADC1_setCh17IntNodePtr.c
    * @brief Unit tests for ADC1_setCh17IntNodePtr.
    *
    * @anchor UT_ADC1_setCh17IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh17IntNodePtr.
    */
    
#include "ADC1_setCh17IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh17IntNodePtr(void)
{
