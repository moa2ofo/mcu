/**
    * @file test/unitTest/TEST_ADC1_setCh18IntNodePtr/test/test_ADC1_setCh18IntNodePtr.c
    * @brief Unit tests for ADC1_setCh18IntNodePtr.
    *
    * @anchor UT_ADC1_setCh18IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh18IntNodePtr.
    */
    
#include "ADC1_setCh18IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh18IntNodePtr(void)
{
