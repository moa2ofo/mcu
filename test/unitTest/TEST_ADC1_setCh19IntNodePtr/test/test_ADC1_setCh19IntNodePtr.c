/**
    * @file test/unitTest/TEST_ADC1_setCh19IntNodePtr/test/test_ADC1_setCh19IntNodePtr.c
    * @brief Unit tests for ADC1_setCh19IntNodePtr.
    *
    * @anchor UT_ADC1_setCh19IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh19IntNodePtr.
    */
    
#include "ADC1_setCh19IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh19IntNodePtr(void)
{
