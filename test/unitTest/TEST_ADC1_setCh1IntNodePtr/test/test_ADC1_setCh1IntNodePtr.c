/**
    * @file test/unitTest/TEST_ADC1_setCh1IntNodePtr/test/test_ADC1_setCh1IntNodePtr.c
    * @brief Unit tests for ADC1_setCh1IntNodePtr.
    *
    * @anchor UT_ADC1_setCh1IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh1IntNodePtr.
    */
    
#include "ADC1_setCh1IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh1IntNodePtr(void)
{
