/**
    * @file test/unitTest/TEST_ADC1_setCh2IntNodePtr/test/test_ADC1_setCh2IntNodePtr.c
    * @brief Unit tests for ADC1_setCh2IntNodePtr.
    *
    * @anchor UT_ADC1_setCh2IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh2IntNodePtr.
    */
    
#include "ADC1_setCh2IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh2IntNodePtr(void)
{
