/**
    * @file test/unitTest/TEST_ADC1_setCh3IntNodePtr/test/test_ADC1_setCh3IntNodePtr.c
    * @brief Unit tests for ADC1_setCh3IntNodePtr.
    *
    * @anchor UT_ADC1_setCh3IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh3IntNodePtr.
    */
    
#include "ADC1_setCh3IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh3IntNodePtr(void)
{
