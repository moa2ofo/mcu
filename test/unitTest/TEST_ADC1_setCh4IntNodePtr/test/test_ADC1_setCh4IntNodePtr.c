/**
    * @file test/unitTest/TEST_ADC1_setCh4IntNodePtr/test/test_ADC1_setCh4IntNodePtr.c
    * @brief Unit tests for ADC1_setCh4IntNodePtr.
    *
    * @anchor UT_ADC1_setCh4IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh4IntNodePtr.
    */
    
#include "ADC1_setCh4IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh4IntNodePtr(void)
{
