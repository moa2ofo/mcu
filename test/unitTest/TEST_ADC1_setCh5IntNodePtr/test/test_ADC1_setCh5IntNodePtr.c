/**
    * @file test/unitTest/TEST_ADC1_setCh5IntNodePtr/test/test_ADC1_setCh5IntNodePtr.c
    * @brief Unit tests for ADC1_setCh5IntNodePtr.
    *
    * @anchor UT_ADC1_setCh5IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh5IntNodePtr.
    */
    
#include "ADC1_setCh5IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh5IntNodePtr(void)
{
