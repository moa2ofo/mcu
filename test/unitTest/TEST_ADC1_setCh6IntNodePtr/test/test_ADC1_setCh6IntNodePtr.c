/**
    * @file test/unitTest/TEST_ADC1_setCh6IntNodePtr/test/test_ADC1_setCh6IntNodePtr.c
    * @brief Unit tests for ADC1_setCh6IntNodePtr.
    *
    * @anchor UT_ADC1_setCh6IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh6IntNodePtr.
    */
    
#include "ADC1_setCh6IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh6IntNodePtr(void)
{
