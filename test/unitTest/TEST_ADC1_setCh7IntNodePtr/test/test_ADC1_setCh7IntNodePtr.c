/**
    * @file test/unitTest/TEST_ADC1_setCh7IntNodePtr/test/test_ADC1_setCh7IntNodePtr.c
    * @brief Unit tests for ADC1_setCh7IntNodePtr.
    *
    * @anchor UT_ADC1_setCh7IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh7IntNodePtr.
    */
    
#include "ADC1_setCh7IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh7IntNodePtr(void)
{
