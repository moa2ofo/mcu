/**
    * @file test/unitTest/TEST_ADC1_setCh8IntNodePtr/test/test_ADC1_setCh8IntNodePtr.c
    * @brief Unit tests for ADC1_setCh8IntNodePtr.
    *
    * @anchor UT_ADC1_setCh8IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh8IntNodePtr.
    */
    
#include "ADC1_setCh8IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh8IntNodePtr(void)
{
