/**
    * @file test/unitTest/TEST_ADC1_setCh9IntNodePtr/test/test_ADC1_setCh9IntNodePtr.c
    * @brief Unit tests for ADC1_setCh9IntNodePtr.
    *
    * @anchor UT_ADC1_setCh9IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCh9IntNodePtr.
    */
    
#include "ADC1_setCh9IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCh9IntNodePtr(void)
{
