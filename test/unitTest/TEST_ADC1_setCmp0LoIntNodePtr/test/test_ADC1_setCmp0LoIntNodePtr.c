/**
    * @file test/unitTest/TEST_ADC1_setCmp0LoIntNodePtr/test/test_ADC1_setCmp0LoIntNodePtr.c
    * @brief Unit tests for ADC1_setCmp0LoIntNodePtr.
    *
    * @anchor UT_ADC1_setCmp0LoIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCmp0LoIntNodePtr.
    */
    
#include "ADC1_setCmp0LoIntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCmp0LoIntNodePtr(void)
{
