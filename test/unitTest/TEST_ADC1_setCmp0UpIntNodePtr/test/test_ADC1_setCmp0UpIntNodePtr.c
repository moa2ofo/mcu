/**
    * @file test/unitTest/TEST_ADC1_setCmp0UpIntNodePtr/test/test_ADC1_setCmp0UpIntNodePtr.c
    * @brief Unit tests for ADC1_setCmp0UpIntNodePtr.
    *
    * @anchor UT_ADC1_setCmp0UpIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCmp0UpIntNodePtr.
    */
    
#include "ADC1_setCmp0UpIntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCmp0UpIntNodePtr(void)
{
