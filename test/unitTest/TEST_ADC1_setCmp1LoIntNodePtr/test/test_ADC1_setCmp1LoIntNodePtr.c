/**
    * @file test/unitTest/TEST_ADC1_setCmp1LoIntNodePtr/test/test_ADC1_setCmp1LoIntNodePtr.c
    * @brief Unit tests for ADC1_setCmp1LoIntNodePtr.
    *
    * @anchor UT_ADC1_setCmp1LoIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCmp1LoIntNodePtr.
    */
    
#include "ADC1_setCmp1LoIntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCmp1LoIntNodePtr(void)
{
