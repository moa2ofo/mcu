/**
    * @file test/unitTest/TEST_ADC1_setCmp1UpIntNodePtr/test/test_ADC1_setCmp1UpIntNodePtr.c
    * @brief Unit tests for ADC1_setCmp1UpIntNodePtr.
    *
    * @anchor UT_ADC1_setCmp1UpIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCmp1UpIntNodePtr.
    */
    
#include "ADC1_setCmp1UpIntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCmp1UpIntNodePtr(void)
{
