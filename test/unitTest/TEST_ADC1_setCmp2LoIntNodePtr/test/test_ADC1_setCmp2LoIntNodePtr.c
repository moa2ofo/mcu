/**
    * @file test/unitTest/TEST_ADC1_setCmp2LoIntNodePtr/test/test_ADC1_setCmp2LoIntNodePtr.c
    * @brief Unit tests for ADC1_setCmp2LoIntNodePtr.
    *
    * @anchor UT_ADC1_setCmp2LoIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCmp2LoIntNodePtr.
    */
    
#include "ADC1_setCmp2LoIntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCmp2LoIntNodePtr(void)
{
