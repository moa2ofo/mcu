/**
    * @file test/unitTest/TEST_ADC1_setCmp2UpIntNodePtr/test/test_ADC1_setCmp2UpIntNodePtr.c
    * @brief Unit tests for ADC1_setCmp2UpIntNodePtr.
    *
    * @anchor UT_ADC1_setCmp2UpIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCmp2UpIntNodePtr.
    */
    
#include "ADC1_setCmp2UpIntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCmp2UpIntNodePtr(void)
{
