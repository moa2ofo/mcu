/**
    * @file test/unitTest/TEST_ADC1_setCmp3UpIntNodePtr/test/test_ADC1_setCmp3UpIntNodePtr.c
    * @brief Unit tests for ADC1_setCmp3UpIntNodePtr.
    *
    * @anchor UT_ADC1_setCmp3UpIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setCmp3UpIntNodePtr.
    */
    
#include "ADC1_setCmp3UpIntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setCmp3UpIntNodePtr(void)
{
