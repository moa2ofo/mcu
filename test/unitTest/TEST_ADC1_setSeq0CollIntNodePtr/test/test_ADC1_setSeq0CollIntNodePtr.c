/**
    * @file test/unitTest/TEST_ADC1_setSeq0CollIntNodePtr/test/test_ADC1_setSeq0CollIntNodePtr.c
    * @brief Unit tests for ADC1_setSeq0CollIntNodePtr.
    *
    * @anchor UT_ADC1_setSeq0CollIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setSeq0CollIntNodePtr.
    */
    
#include "ADC1_setSeq0CollIntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setSeq0CollIntNodePtr(void)
{
