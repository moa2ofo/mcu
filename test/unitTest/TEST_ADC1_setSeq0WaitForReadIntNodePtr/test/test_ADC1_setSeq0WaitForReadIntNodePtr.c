/**
    * @file test/unitTest/TEST_ADC1_setSeq0WaitForReadIntNodePtr/test/test_ADC1_setSeq0WaitForReadIntNodePtr.c
    * @brief Unit tests for ADC1_setSeq0WaitForReadIntNodePtr.
    *
    * @anchor UT_ADC1_setSeq0WaitForReadIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setSeq0WaitForReadIntNodePtr.
    */
    
#include "ADC1_setSeq0WaitForReadIntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setSeq0WaitForReadIntNodePtr(void)
{
