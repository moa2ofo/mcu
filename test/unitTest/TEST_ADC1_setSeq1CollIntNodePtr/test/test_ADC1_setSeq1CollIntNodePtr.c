/**
    * @file test/unitTest/TEST_ADC1_setSeq1CollIntNodePtr/test/test_ADC1_setSeq1CollIntNodePtr.c
    * @brief Unit tests for ADC1_setSeq1CollIntNodePtr.
    *
    * @anchor UT_ADC1_setSeq1CollIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setSeq1CollIntNodePtr.
    */
    
#include "ADC1_setSeq1CollIntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setSeq1CollIntNodePtr(void)
{
