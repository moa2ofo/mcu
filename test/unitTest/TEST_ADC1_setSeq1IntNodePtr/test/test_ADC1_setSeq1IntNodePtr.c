/**
    * @file test/unitTest/TEST_ADC1_setSeq1IntNodePtr/test/test_ADC1_setSeq1IntNodePtr.c
    * @brief Unit tests for ADC1_setSeq1IntNodePtr.
    *
    * @anchor UT_ADC1_setSeq1IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setSeq1IntNodePtr.
    */
    
#include "ADC1_setSeq1IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setSeq1IntNodePtr(void)
{
