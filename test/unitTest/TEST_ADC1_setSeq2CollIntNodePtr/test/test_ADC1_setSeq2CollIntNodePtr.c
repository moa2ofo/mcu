/**
    * @file test/unitTest/TEST_ADC1_setSeq2CollIntNodePtr/test/test_ADC1_setSeq2CollIntNodePtr.c
    * @brief Unit tests for ADC1_setSeq2CollIntNodePtr.
    *
    * @anchor UT_ADC1_setSeq2CollIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setSeq2CollIntNodePtr.
    */
    
#include "ADC1_setSeq2CollIntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setSeq2CollIntNodePtr(void)
{
