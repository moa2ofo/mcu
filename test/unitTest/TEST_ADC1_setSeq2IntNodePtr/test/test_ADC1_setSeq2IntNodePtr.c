/**
    * @file test/unitTest/TEST_ADC1_setSeq2IntNodePtr/test/test_ADC1_setSeq2IntNodePtr.c
    * @brief Unit tests for ADC1_setSeq2IntNodePtr.
    *
    * @anchor UT_ADC1_setSeq2IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setSeq2IntNodePtr.
    */
    
#include "ADC1_setSeq2IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setSeq2IntNodePtr(void)
{
