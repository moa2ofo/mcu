/**
    * @file test/unitTest/TEST_ADC1_setSeq2WaitForReadIntNodePtr/test/test_ADC1_setSeq2WaitForReadIntNodePtr.c
    * @brief Unit tests for ADC1_setSeq2WaitForReadIntNodePtr.
    *
    * @anchor UT_ADC1_setSeq2WaitForReadIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setSeq2WaitForReadIntNodePtr.
    */
    
#include "ADC1_setSeq2WaitForReadIntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setSeq2WaitForReadIntNodePtr(void)
{
