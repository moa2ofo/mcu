/**
    * @file test/unitTest/TEST_ADC1_setSeq3CollIntNodePtr/test/test_ADC1_setSeq3CollIntNodePtr.c
    * @brief Unit tests for ADC1_setSeq3CollIntNodePtr.
    *
    * @anchor UT_ADC1_setSeq3CollIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setSeq3CollIntNodePtr.
    */
    
#include "ADC1_setSeq3CollIntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setSeq3CollIntNodePtr(void)
{
