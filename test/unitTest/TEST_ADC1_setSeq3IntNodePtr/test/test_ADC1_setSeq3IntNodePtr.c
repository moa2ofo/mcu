/**
    * @file test/unitTest/TEST_ADC1_setSeq3IntNodePtr/test/test_ADC1_setSeq3IntNodePtr.c
    * @brief Unit tests for ADC1_setSeq3IntNodePtr.
    *
    * @anchor UT_ADC1_setSeq3IntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setSeq3IntNodePtr.
    */
    
#include "ADC1_setSeq3IntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setSeq3IntNodePtr(void)
{
