/**
    * @file test/unitTest/TEST_ADC1_setSeq3WaitForReadIntNodePtr/test/test_ADC1_setSeq3WaitForReadIntNodePtr.c
    * @brief Unit tests for ADC1_setSeq3WaitForReadIntNodePtr.
    *
    * @anchor UT_ADC1_setSeq3WaitForReadIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC1_setSeq3WaitForReadIntNodePtr.
    */
    
#include "ADC1_setSeq3WaitForReadIntNodePtr.h"
#include "unity.h"
...
void test_ADC1_setSeq3WaitForReadIntNodePtr(void)
{
