/**
    * @file test/unitTest/TEST_ADC1_startSequence/test/test_ADC1_startSequence.c
    * @brief Unit tests for ADC1_startSequence.
    *
    * @anchor UT_ADC1_startSequence
    *
    * @details
...
void test_ADC1_startSequence(void)
{
