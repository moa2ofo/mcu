/**
    * @file test/unitTest/TEST_ADC2_getChFiltResult/test/test_ADC2_getChFiltResult.c
    * @brief Unit tests for ADC2_getChFiltResult.
    *
    * @anchor UT_ADC2_getChFiltResult
    *
    * @details
...
#include "ADC2_getChFiltResult.h"
#include "unity.h"
...
void test_ADC2_getChFiltResult(void)
{
