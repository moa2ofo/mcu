/**
    * @file test/unitTest/TEST_ADC2_getChFiltResult_mV/test/test_ADC2_getChFiltResult_mV.c
    * @brief Unit tests for ADC2_getChFiltResult_mV.
    *
    * @anchor UT_ADC2_getChFiltResult_mV
    *
    * @details
...
#include "ADC2_getChFiltResult_mV.h"
#include "unity.h"
...
void test_ADC2_getChFiltResult_mV(void)
{
