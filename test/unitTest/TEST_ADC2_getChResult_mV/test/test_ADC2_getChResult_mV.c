/**
    * @file test/unitTest/TEST_ADC2_getChResult_mV/test/test_ADC2_getChResult_mV.c
    * @brief Unit tests for ADC2_getChResult_mV.
    *
    * @anchor UT_ADC2_getChResult_mV
    *
    * @details
...
void test_ADC2_getChResult_mV(void)
{
