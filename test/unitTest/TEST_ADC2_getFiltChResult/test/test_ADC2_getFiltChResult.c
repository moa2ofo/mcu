/**
    * @file test/unitTest/TEST_ADC2_getFiltChResult/test/test_ADC2_getFiltChResult.c
    * @brief Unit tests for ADC2_getFiltChResult.
    *
    * @anchor UT_ADC2_getFiltChResult
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC2_getFiltChResult.
    */
    
#include "ADC2_getFiltChResult.h"
#include "unity.h"
...
void test_ADC2_getFiltChResult(void)
{
