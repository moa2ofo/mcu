/**
    * @file test/unitTest/TEST_ADC2_getFiltIdxFromChannel/test/test_ADC2_getFiltIdxFromChannel.c
    * @brief Unit tests for ADC2_getFiltIdxFromChannel.
    *
    * @anchor UT_ADC2_getFiltIdxFromChannel
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * ADC2_getFiltIdxFromChannel.
    */
    
#include "ADC2_getFiltIdxFromChannel.h"
#include "unity.h"
...
void test_ADC2_getFiltIdxFromChannel(void)
{
