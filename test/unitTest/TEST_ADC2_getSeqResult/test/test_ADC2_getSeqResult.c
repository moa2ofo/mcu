/**
    * @file test/unitTest/TEST_ADC2_getSeqResult/test/test_ADC2_getSeqResult.c
    * @brief Unit tests for ADC2_getSeqResult.
    *
    * @anchor UT_ADC2_getSeqResult
    *
    * @details
...
void test_ADC2_getSeqResult(void)
{
