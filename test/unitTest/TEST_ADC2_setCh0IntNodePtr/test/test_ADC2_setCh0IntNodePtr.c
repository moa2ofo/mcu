/**
    * @file test/unitTest/TEST_ADC2_setCh0IntNodePtr/test/test_ADC2_setCh0IntNodePtr.c
    * @brief Unit tests for ADC2_setCh0IntNodePtr.
    *
    * @anchor UT_ADC2_setCh0IntNodePtr
    *
    * @details
...
#include "ADC2_setCh0IntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCh0IntNodePtr(void)
{
