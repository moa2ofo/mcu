/**
    * @file test/unitTest/TEST_ADC2_setCh10IntNodePtr/test/test_ADC2_setCh10IntNodePtr.c
    * @brief Unit tests for ADC2_setCh10IntNodePtr.
    *
    * @anchor UT_ADC2_setCh10IntNodePtr
    *
    * @details
...
#include "ADC2_setCh10IntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCh10IntNodePtr(void)
{
