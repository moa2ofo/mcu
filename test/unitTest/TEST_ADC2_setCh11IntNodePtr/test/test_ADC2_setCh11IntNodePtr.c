/**
    * @file test/unitTest/TEST_ADC2_setCh11IntNodePtr/test/test_ADC2_setCh11IntNodePtr.c
    * @brief Unit tests for ADC2_setCh11IntNodePtr.
    *
    * @anchor UT_ADC2_setCh11IntNodePtr
    *
    * @details
...
#include "ADC2_setCh11IntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCh11IntNodePtr(void)
{
