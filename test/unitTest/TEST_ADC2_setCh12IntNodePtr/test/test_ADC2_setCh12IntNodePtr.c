/**
    * @file test/unitTest/TEST_ADC2_setCh12IntNodePtr/test/test_ADC2_setCh12IntNodePtr.c
    * @brief Unit tests for ADC2_setCh12IntNodePtr.
    *
    * @anchor UT_ADC2_setCh12IntNodePtr
    *
    * @details
...
#include "ADC2_setCh12IntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCh12IntNodePtr(void)
{
