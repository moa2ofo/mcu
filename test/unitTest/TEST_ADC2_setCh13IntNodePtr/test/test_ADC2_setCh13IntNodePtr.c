/**
    * @file test/unitTest/TEST_ADC2_setCh13IntNodePtr/test/test_ADC2_setCh13IntNodePtr.c
    * @brief Unit tests for ADC2_setCh13IntNodePtr.
    *
    * @anchor UT_ADC2_setCh13IntNodePtr
    *
    * @details
...
#include "ADC2_setCh13IntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCh13IntNodePtr(void)
{
