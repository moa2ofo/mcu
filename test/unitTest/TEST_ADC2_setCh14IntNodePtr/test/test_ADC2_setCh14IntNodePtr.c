/**
    * @file test/unitTest/TEST_ADC2_setCh14IntNodePtr/test/test_ADC2_setCh14IntNodePtr.c
    * @brief Unit tests for ADC2_setCh14IntNodePtr.
    *
    * @anchor UT_ADC2_setCh14IntNodePtr
    *
    * @details
...
#include "ADC2_setCh14IntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCh14IntNodePtr(void)
{
