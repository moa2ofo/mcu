/**
    * @file test/unitTest/TEST_ADC2_setCh1IntNodePtr/test/test_ADC2_setCh1IntNodePtr.c
    * @brief Unit tests for ADC2_setCh1IntNodePtr.
    *
    * @anchor UT_ADC2_setCh1IntNodePtr
    *
    * @details
...
#include "ADC2_setCh1IntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCh1IntNodePtr(void)
{
