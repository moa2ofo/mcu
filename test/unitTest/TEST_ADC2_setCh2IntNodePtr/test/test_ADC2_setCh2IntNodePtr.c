/**
    * @file test/unitTest/TEST_ADC2_setCh2IntNodePtr/test/test_ADC2_setCh2IntNodePtr.c
    * @brief Unit tests for ADC2_setCh2IntNodePtr.
    *
    * @anchor UT_ADC2_setCh2IntNodePtr
    *
    * @details
...
#include "ADC2_setCh2IntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCh2IntNodePtr(void)
{
