/**
    * @file test/unitTest/TEST_ADC2_setCh3IntNodePtr/test/test_ADC2_setCh3IntNodePtr.c
    * @brief Unit tests for ADC2_setCh3IntNodePtr.
    *
    * @anchor UT_ADC2_setCh3IntNodePtr
    *
    * @details
...
#include "ADC2_setCh3IntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCh3IntNodePtr(void)
{
