/**
    * @file test/unitTest/TEST_ADC2_setCh4IntNodePtr/test/test_ADC2_setCh4IntNodePtr.c
    * @brief Unit tests for ADC2_setCh4IntNodePtr.
    *
    * @anchor UT_ADC2_setCh4IntNodePtr
    *
    * @details
...
#include "ADC2_setCh4IntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCh4IntNodePtr(void)
{
