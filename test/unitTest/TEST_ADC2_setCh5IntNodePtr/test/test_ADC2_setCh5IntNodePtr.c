/**
    * @file test/unitTest/TEST_ADC2_setCh5IntNodePtr/test/test_ADC2_setCh5IntNodePtr.c
    * @brief Unit tests for ADC2_setCh5IntNodePtr.
    *
    * @anchor UT_ADC2_setCh5IntNodePtr
    *
    * @details
...
#include "ADC2_setCh5IntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCh5IntNodePtr(void)
{
