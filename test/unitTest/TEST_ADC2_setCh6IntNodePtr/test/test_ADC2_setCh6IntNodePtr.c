/**
    * @file test/unitTest/TEST_ADC2_setCh6IntNodePtr/test/test_ADC2_setCh6IntNodePtr.c
    * @brief Unit tests for ADC2_setCh6IntNodePtr.
    *
    * @anchor UT_ADC2_setCh6IntNodePtr
    *
    * @details
...
#include "ADC2_setCh6IntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCh6IntNodePtr(void)
{
