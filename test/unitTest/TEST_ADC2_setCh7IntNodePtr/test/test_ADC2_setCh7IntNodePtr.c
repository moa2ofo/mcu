/**
    * @file test/unitTest/TEST_ADC2_setCh7IntNodePtr/test/test_ADC2_setCh7IntNodePtr.c
    * @brief Unit tests for ADC2_setCh7IntNodePtr.
    *
    * @anchor UT_ADC2_setCh7IntNodePtr
    *
    * @details
...
#include "ADC2_setCh7IntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCh7IntNodePtr(void)
{
