/**
    * @file test/unitTest/TEST_ADC2_setCh9IntNodePtr/test/test_ADC2_setCh9IntNodePtr.c
    * @brief Unit tests for ADC2_setCh9IntNodePtr.
    *
    * @anchor UT_ADC2_setCh9IntNodePtr
    *
    * @details
...
#include "ADC2_setCh9IntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCh9IntNodePtr(void)
{
