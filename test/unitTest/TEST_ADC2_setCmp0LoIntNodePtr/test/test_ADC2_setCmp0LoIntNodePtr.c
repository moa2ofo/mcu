/**
    * @file test/unitTest/TEST_ADC2_setCmp0LoIntNodePtr/test/test_ADC2_setCmp0LoIntNodePtr.c
    * @brief Unit tests for ADC2_setCmp0LoIntNodePtr.
    *
    * @anchor UT_ADC2_setCmp0LoIntNodePtr
    *
    * @details
...
#include "ADC2_setCmp0LoIntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCmp0LoIntNodePtr(void)
{
