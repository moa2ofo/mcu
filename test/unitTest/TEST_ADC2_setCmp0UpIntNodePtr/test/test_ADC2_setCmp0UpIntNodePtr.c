/**
    * @file test/unitTest/TEST_ADC2_setCmp0UpIntNodePtr/test/test_ADC2_setCmp0UpIntNodePtr.c
    * @brief Unit tests for ADC2_setCmp0UpIntNodePtr.
    *
    * @anchor UT_ADC2_setCmp0UpIntNodePtr
    *
    * @details
...
#include "ADC2_setCmp0UpIntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCmp0UpIntNodePtr(void)
{
