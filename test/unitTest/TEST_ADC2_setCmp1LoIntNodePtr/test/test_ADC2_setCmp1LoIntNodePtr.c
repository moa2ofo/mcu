/**
    * @file test/unitTest/TEST_ADC2_setCmp1LoIntNodePtr/test/test_ADC2_setCmp1LoIntNodePtr.c
    * @brief Unit tests for ADC2_setCmp1LoIntNodePtr.
    *
    * @anchor UT_ADC2_setCmp1LoIntNodePtr
    *
    * @details
...
#include "ADC2_setCmp1LoIntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCmp1LoIntNodePtr(void)
{
