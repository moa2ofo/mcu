/**
    * @file test/unitTest/TEST_ADC2_setCmp1UpIntNodePtr/test/test_ADC2_setCmp1UpIntNodePtr.c
    * @brief Unit tests for ADC2_setCmp1UpIntNodePtr.
    *
    * @anchor UT_ADC2_setCmp1UpIntNodePtr
    *
    * @details
...
#include "ADC2_setCmp1UpIntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCmp1UpIntNodePtr(void)
{
