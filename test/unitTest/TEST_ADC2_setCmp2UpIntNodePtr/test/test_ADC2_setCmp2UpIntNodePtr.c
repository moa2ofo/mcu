/**
    * @file test/unitTest/TEST_ADC2_setCmp2UpIntNodePtr/test/test_ADC2_setCmp2UpIntNodePtr.c
    * @brief Unit tests for ADC2_setCmp2UpIntNodePtr.
    *
    * @anchor UT_ADC2_setCmp2UpIntNodePtr
    *
    * @details
...
#include "ADC2_setCmp2UpIntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCmp2UpIntNodePtr(void)
{
