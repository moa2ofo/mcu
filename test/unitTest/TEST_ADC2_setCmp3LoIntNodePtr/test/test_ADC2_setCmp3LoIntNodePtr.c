/**
    * @file test/unitTest/TEST_ADC2_setCmp3LoIntNodePtr/test/test_ADC2_setCmp3LoIntNodePtr.c
    * @brief Unit tests for ADC2_setCmp3LoIntNodePtr.
    *
    * @anchor UT_ADC2_setCmp3LoIntNodePtr
    *
    * @details
...
#include "ADC2_setCmp3LoIntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCmp3LoIntNodePtr(void)
{
