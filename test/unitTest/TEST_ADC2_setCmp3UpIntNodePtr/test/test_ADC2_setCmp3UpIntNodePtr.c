/**
    * @file test/unitTest/TEST_ADC2_setCmp3UpIntNodePtr/test/test_ADC2_setCmp3UpIntNodePtr.c
    * @brief Unit tests for ADC2_setCmp3UpIntNodePtr.
    *
    * @anchor UT_ADC2_setCmp3UpIntNodePtr
    *
    * @details
...
#include "ADC2_setCmp3UpIntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCmp3UpIntNodePtr(void)
{
