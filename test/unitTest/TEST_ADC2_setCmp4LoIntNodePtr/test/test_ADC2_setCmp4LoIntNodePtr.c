/**
    * @file test/unitTest/TEST_ADC2_setCmp4LoIntNodePtr/test/test_ADC2_setCmp4LoIntNodePtr.c
    * @brief Unit tests for ADC2_setCmp4LoIntNodePtr.
    *
    * @anchor UT_ADC2_setCmp4LoIntNodePtr
    *
    * @details
...
#include "ADC2_setCmp4LoIntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCmp4LoIntNodePtr(void)
{
