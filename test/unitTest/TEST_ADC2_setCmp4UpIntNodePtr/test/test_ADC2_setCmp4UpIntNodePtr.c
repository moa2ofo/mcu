/**
    * @file test/unitTest/TEST_ADC2_setCmp4UpIntNodePtr/test/test_ADC2_setCmp4UpIntNodePtr.c
    * @brief Unit tests for ADC2_setCmp4UpIntNodePtr.
    *
    * @anchor UT_ADC2_setCmp4UpIntNodePtr
    *
    * @details
...
#include "ADC2_setCmp4UpIntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCmp4UpIntNodePtr(void)
{
