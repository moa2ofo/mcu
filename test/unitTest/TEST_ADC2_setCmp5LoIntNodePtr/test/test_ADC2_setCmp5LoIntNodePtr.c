/**
    * @file test/unitTest/TEST_ADC2_setCmp5LoIntNodePtr/test/test_ADC2_setCmp5LoIntNodePtr.c
    * @brief Unit tests for ADC2_setCmp5LoIntNodePtr.
    *
    * @anchor UT_ADC2_setCmp5LoIntNodePtr
    *
    * @details
...
#include "ADC2_setCmp5LoIntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCmp5LoIntNodePtr(void)
{
