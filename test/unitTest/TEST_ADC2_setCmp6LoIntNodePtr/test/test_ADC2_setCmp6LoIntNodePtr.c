/**
    * @file test/unitTest/TEST_ADC2_setCmp6LoIntNodePtr/test/test_ADC2_setCmp6LoIntNodePtr.c
    * @brief Unit tests for ADC2_setCmp6LoIntNodePtr.
    *
    * @anchor UT_ADC2_setCmp6LoIntNodePtr
    *
    * @details
...
#include "ADC2_setCmp6LoIntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCmp6LoIntNodePtr(void)
{
