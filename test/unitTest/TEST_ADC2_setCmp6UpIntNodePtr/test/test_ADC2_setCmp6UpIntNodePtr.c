/**
    * @file test/unitTest/TEST_ADC2_setCmp6UpIntNodePtr/test/test_ADC2_setCmp6UpIntNodePtr.c
    * @brief Unit tests for ADC2_setCmp6UpIntNodePtr.
    *
    * @anchor UT_ADC2_setCmp6UpIntNodePtr
    *
    * @details
...
#include "ADC2_setCmp6UpIntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCmp6UpIntNodePtr(void)
{
