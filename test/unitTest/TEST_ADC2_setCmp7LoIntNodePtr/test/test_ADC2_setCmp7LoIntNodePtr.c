/**
    * @file test/unitTest/TEST_ADC2_setCmp7LoIntNodePtr/test/test_ADC2_setCmp7LoIntNodePtr.c
    * @brief Unit tests for ADC2_setCmp7LoIntNodePtr.
    *
    * @anchor UT_ADC2_setCmp7LoIntNodePtr
    *
    * @details
...
#include "ADC2_setCmp7LoIntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCmp7LoIntNodePtr(void)
{
