/**
    * @file test/unitTest/TEST_ADC2_setCmp7UpIntNodePtr/test/test_ADC2_setCmp7UpIntNodePtr.c
    * @brief Unit tests for ADC2_setCmp7UpIntNodePtr.
    *
    * @anchor UT_ADC2_setCmp7UpIntNodePtr
    *
    * @details
...
#include "ADC2_setCmp7UpIntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setCmp7UpIntNodePtr(void)
{
