/**
    * @file test/unitTest/TEST_ADC2_setSeq0IntNodePtr/test/test_ADC2_setSeq0IntNodePtr.c
    * @brief Unit tests for ADC2_setSeq0IntNodePtr.
    *
    * @anchor UT_ADC2_setSeq0IntNodePtr
    *
    * @details
...
#include "ADC2_setSeq0IntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setSeq0IntNodePtr(void)
{
