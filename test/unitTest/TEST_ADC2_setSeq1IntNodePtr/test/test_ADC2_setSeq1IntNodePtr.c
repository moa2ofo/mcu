/**
    * @file test/unitTest/TEST_ADC2_setSeq1IntNodePtr/test/test_ADC2_setSeq1IntNodePtr.c
    * @brief Unit tests for ADC2_setSeq1IntNodePtr.
    *
    * @anchor UT_ADC2_setSeq1IntNodePtr
    *
    * @details
...
#include "ADC2_setSeq1IntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setSeq1IntNodePtr(void)
{
