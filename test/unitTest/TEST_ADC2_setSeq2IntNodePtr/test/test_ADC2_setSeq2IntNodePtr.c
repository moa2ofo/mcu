/**
    * @file test/unitTest/TEST_ADC2_setSeq2IntNodePtr/test/test_ADC2_setSeq2IntNodePtr.c
    * @brief Unit tests for ADC2_setSeq2IntNodePtr.
    *
    * @anchor UT_ADC2_setSeq2IntNodePtr
    *
    * @details
...
#include "ADC2_setSeq2IntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setSeq2IntNodePtr(void)
{
