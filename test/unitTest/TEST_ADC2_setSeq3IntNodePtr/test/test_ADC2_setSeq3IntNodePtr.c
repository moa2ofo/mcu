/**
    * @file test/unitTest/TEST_ADC2_setSeq3IntNodePtr/test/test_ADC2_setSeq3IntNodePtr.c
    * @brief Unit tests for ADC2_setSeq3IntNodePtr.
    *
    * @anchor UT_ADC2_setSeq3IntNodePtr
    *
    * @details
...
#include "ADC2_setSeq3IntNodePtr.h"
#include "unity.h"
...
void test_ADC2_setSeq3IntNodePtr(void)
{
