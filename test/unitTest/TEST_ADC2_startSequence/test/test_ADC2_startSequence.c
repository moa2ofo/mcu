/**
    * @file test/unitTest/TEST_ADC2_startSequence/test/test_ADC2_startSequence.c
    * @brief Unit tests for ADC2_startSequence.
    *
    * @anchor UT_ADC2_startSequence
    *
    * @details
...
void test_ADC2_startSequence(void)
{
