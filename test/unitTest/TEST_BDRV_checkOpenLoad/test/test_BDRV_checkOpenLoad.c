/**
    * @file test/unitTest/TEST_BDRV_checkOpenLoad/test/test_BDRV_checkOpenLoad.c
    * @brief Unit tests for BDRV_checkOpenLoad.
    *
    * @anchor UT_BDRV_checkOpenLoad
    *
    * @details
...
void test_BDRV_checkOpenLoad(void)
{
