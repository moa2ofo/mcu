/**
    * @file test/unitTest/TEST_BDRV_checkShortDiagnosis/test/test_BDRV_checkShortDiagnosis.c
    * @brief Unit tests for BDRV_checkShortDiagnosis.
    *
    * @anchor UT_BDRV_checkShortDiagnosis
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_checkShortDiagnosis.
    */
    
#include "BDRV_checkShortDiagnosis.h"
#include "unity.h"
...
void test_BDRV_checkShortDiagnosis(void)
{
