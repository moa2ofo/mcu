/**
    * @file test/unitTest/TEST_BDRV_clrFaultSts/test/test_BDRV_clrFaultSts.c
    * @brief Unit tests for BDRV_clrFaultSts.
    *
    * @anchor UT_BDRV_clrFaultSts
    *
    * @details
...
void test_BDRV_clrFaultSts(void)
{
