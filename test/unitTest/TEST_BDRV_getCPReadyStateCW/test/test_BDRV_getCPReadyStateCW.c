/**
    * @file test/unitTest/TEST_BDRV_getCPReadyStateCW/test/test_BDRV_getCPReadyStateCW.c
    * @brief Unit tests for BDRV_getCPReadyStateCW.
    *
    * @anchor UT_BDRV_getCPReadyStateCW
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_getCPReadyStateCW.
    */
    
#include "BDRV_getCPReadyStateCW.h"
#include "unity.h"
...
void test_BDRV_getCPReadyStateCW(void)
{
