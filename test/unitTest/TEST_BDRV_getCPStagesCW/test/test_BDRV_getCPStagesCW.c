/**
    * @file test/unitTest/TEST_BDRV_getCPStagesCW/test/test_BDRV_getCPStagesCW.c
    * @brief Unit tests for BDRV_getCPStagesCW.
    *
    * @anchor UT_BDRV_getCPStagesCW
    *
    * @details
...
void test_BDRV_getCPStagesCW(void)
{
