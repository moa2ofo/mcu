/**
    * @file test/unitTest/TEST_BDRV_getFaultSts/test/test_BDRV_getFaultSts.c
    * @brief Unit tests for BDRV_getFaultSts.
    *
    * @anchor UT_BDRV_getFaultSts
    *
    * @details
...
void test_BDRV_getFaultSts(void)
{
