/**
    * @file test/unitTest/TEST_BDRV_getFaults/test/test_BDRV_getFaults.c
    * @brief Unit tests for BDRV_getFaults.
    *
    * @anchor UT_BDRV_getFaults
    *
    * @details
