/**
    * @file test/unitTest/TEST_BDRV_initCP/test/test_BDRV_initCP.c
    * @brief Unit tests for BDRV_initCP.
    *
    * @anchor UT_BDRV_initCP
    *
    * @details
