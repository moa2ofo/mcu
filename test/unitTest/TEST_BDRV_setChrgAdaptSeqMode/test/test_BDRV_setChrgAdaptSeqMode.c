/**
    * @file test/unitTest/TEST_BDRV_setChrgAdaptSeqMode/test/test_BDRV_setChrgAdaptSeqMode.c
    * @brief Unit tests for BDRV_setChrgAdaptSeqMode.
    *
    * @anchor UT_BDRV_setChrgAdaptSeqMode
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setChrgAdaptSeqMode.
    */
    
#include "BDRV_setChrgAdaptSeqMode.h"
#include "unity.h"
...
void test_BDRV_setChrgAdaptSeqMode(void)
{
