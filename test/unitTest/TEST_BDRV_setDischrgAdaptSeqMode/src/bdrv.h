...
** V0.7.4: 2021-07-27, BG:   EP-814: Corrected the value to clear the register**
**                           STSCLR                                           **
** V0.7.5: 2021-07-30, BG:   EP-877: Corrected MISRA 2012 errors              **
** V0.7.6: 2021-08-04, BG:   EP-879: Updated BDRV_init() with extra accessors **
**                           for charge pump register                         **
**                           Corrected the value for the CP stages number in  **
**                           while-loop condition                             **
**                           Updated limits for CP voltage comparison to VSD  **
** V0.7.7: 2021-09-29, BG:   EP-880: Updated BDRV_setBridge(..) so that the   **
**                           function does not violate HW requirements when   **
**                           called with specific arguments                   **
** V0.7.8: 2021-11-08, BG:   EP-790: Combined struct typedef for charge and   **
**                           discharge, renamed existing struct elements for  **
**                           active driver, added elements for free-wheeling  **
**                           driver                                           **
**                           Updated functions according to the AK design step**
**                           BDRV_set{LS/HS}{Chrg/Dischrg}{Const/Seq}Mode     **
** V0.7.9: 2021-11-12, JO:   EP-937: Updated copyright and branding           **
** V0.8.0: 2022-06-23, JO:   EP-1150: Removed ARMCC V6.18 warnings            **
** V0.8.1: 2022-07-05, JO:   EP-1188: Disabled MISRA rule 9031 locally        **
** V0.8.2: 2022-11-17, JO:   EP-1342: Updated enum documentation to remove    **
**                           doxygen warning                                  **
** V0.8.3: 2023-04-04, PS:   EP-1141: Corrected MISRA warnings                **
** V0.9.0: 2024-06-03, JO:   EP-1388: Added functions to access single bits   **
**                           of register BDRV->PROT_CTRL                      **
** V0.9.1: 2024-11-05, JO:   EP-1494: Updated license                         **
** V0.9.2: 2024-11-18, VO:   EP-1543: Correct min VCP voltage in BDRV init    **
*******************************************************************************/
