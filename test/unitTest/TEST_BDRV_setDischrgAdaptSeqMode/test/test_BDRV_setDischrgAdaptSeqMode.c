/**
    * @file test/unitTest/TEST_BDRV_setDischrgAdaptSeqMode/test/test_BDRV_setDischrgAdaptSeqMode.c
    * @brief Unit tests for BDRV_setDischrgAdaptSeqMode.
    *
    * @anchor UT_BDRV_setDischrgAdaptSeqMode
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setDischrgAdaptSeqMode.
    */
    
#include "BDRV_setDischrgAdaptSeqMode.h"
#include "unity.h"
...
void test_BDRV_setDischrgAdaptSeqMode(void)
{
