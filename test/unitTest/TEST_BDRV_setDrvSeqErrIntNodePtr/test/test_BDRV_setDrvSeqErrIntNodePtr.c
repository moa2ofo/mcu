/**
    * @file test/unitTest/TEST_BDRV_setDrvSeqErrIntNodePtr/test/test_BDRV_setDrvSeqErrIntNodePtr.c
    * @brief Unit tests for BDRV_setDrvSeqErrIntNodePtr.
    *
    * @anchor UT_BDRV_setDrvSeqErrIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setDrvSeqErrIntNodePtr.
    */
    
#include "BDRV_setDrvSeqErrIntNodePtr.h"
#include "unity.h"
...
void test_BDRV_setDrvSeqErrIntNodePtr(void)
{
