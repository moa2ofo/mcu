#ifndef TEST_BDRV_SETEXTERNALHS1MOSFETOVERCURRENTINTNODEPTR_H
#define TEST_BDRV_SETEXTERNALHS1MOSFETOVERCURRENTINTNODEPTR_H
...
#endif /* TEST_BDRV_SETEXTERNALHS1MOSFETOVERCURRENTINTNODEPTR_H */
