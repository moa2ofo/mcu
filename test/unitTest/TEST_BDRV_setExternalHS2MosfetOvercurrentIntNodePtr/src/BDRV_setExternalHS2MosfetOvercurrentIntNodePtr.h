#ifndef TEST_BDRV_SETEXTERNALHS2MOSFETOVERCURRENTINTNODEPTR_H
#define TEST_BDRV_SETEXTERNALHS2MOSFETOVERCURRENTINTNODEPTR_H
...
#endif /* TEST_BDRV_SETEXTERNALHS2MOSFETOVERCURRENTINTNODEPTR_H */
