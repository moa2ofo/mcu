#ifndef TEST_BDRV_SETEXTERNALLS2MOSFETOVERCURRENTINTNODEPTR_H
#define TEST_BDRV_SETEXTERNALLS2MOSFETOVERCURRENTINTNODEPTR_H
...
#endif /* TEST_BDRV_SETEXTERNALLS2MOSFETOVERCURRENTINTNODEPTR_H */
