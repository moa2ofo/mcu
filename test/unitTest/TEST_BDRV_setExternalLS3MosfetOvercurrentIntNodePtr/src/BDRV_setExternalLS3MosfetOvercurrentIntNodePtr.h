#ifndef TEST_BDRV_SETEXTERNALLS3MOSFETOVERCURRENTINTNODEPTR_H
#define TEST_BDRV_SETEXTERNALLS3MOSFETOVERCURRENTINTNODEPTR_H
...
#endif /* TEST_BDRV_SETEXTERNALLS3MOSFETOVERCURRENTINTNODEPTR_H */
