/**
    * @file test/unitTest/TEST_BDRV_setHB1AdaptSeqIntNodePtr/test/test_BDRV_setHB1AdaptSeqIntNodePtr.c
    * @brief Unit tests for BDRV_setHB1AdaptSeqIntNodePtr.
    *
    * @anchor UT_BDRV_setHB1AdaptSeqIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setHB1AdaptSeqIntNodePtr.
    */
...
void test_BDRV_setHB1AdaptSeqIntNodePtr(void)
{
