/**
    * @file test/unitTest/TEST_BDRV_setHB2AdaptSeqIntNodePtr/test/test_BDRV_setHB2AdaptSeqIntNodePtr.c
    * @brief Unit tests for BDRV_setHB2AdaptSeqIntNodePtr.
    *
    * @anchor UT_BDRV_setHB2AdaptSeqIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setHB2AdaptSeqIntNodePtr.
    */
...
void test_BDRV_setHB2AdaptSeqIntNodePtr(void)
{
