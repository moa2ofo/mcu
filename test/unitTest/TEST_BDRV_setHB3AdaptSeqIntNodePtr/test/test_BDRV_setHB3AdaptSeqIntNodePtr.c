/**
    * @file test/unitTest/TEST_BDRV_setHB3AdaptSeqIntNodePtr/test/test_BDRV_setHB3AdaptSeqIntNodePtr.c
    * @brief Unit tests for BDRV_setHB3AdaptSeqIntNodePtr.
    *
    * @anchor UT_BDRV_setHB3AdaptSeqIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setHB3AdaptSeqIntNodePtr.
    */
...
void test_BDRV_setHB3AdaptSeqIntNodePtr(void)
{
