/**
    * @file test/unitTest/TEST_BDRV_setHSChrgConstMode/test/test_BDRV_setHSChrgConstMode.c
    * @brief Unit tests for BDRV_setHSChrgConstMode.
    *
    * @anchor UT_BDRV_setHSChrgConstMode
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setHSChrgConstMode.
    */
    
#include "BDRV_setHSChrgConstMode.h"
#include "unity.h"
...
void test_BDRV_setHSChrgConstMode(void)
{
