/**
    * @file test/unitTest/TEST_BDRV_setHSChrgSeqMode/test/test_BDRV_setHSChrgSeqMode.c
    * @brief Unit tests for BDRV_setHSChrgSeqMode.
    *
    * @anchor UT_BDRV_setHSChrgSeqMode
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setHSChrgSeqMode.
    */
    
#include "BDRV_setHSChrgSeqMode.h"
#include "unity.h"
...
void test_BDRV_setHSChrgSeqMode(void)
{
