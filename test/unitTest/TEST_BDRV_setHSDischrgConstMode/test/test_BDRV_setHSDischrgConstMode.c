/**
    * @file test/unitTest/TEST_BDRV_setHSDischrgConstMode/test/test_BDRV_setHSDischrgConstMode.c
    * @brief Unit tests for BDRV_setHSDischrgConstMode.
    *
    * @anchor UT_BDRV_setHSDischrgConstMode
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setHSDischrgConstMode.
    */
    
#include "BDRV_setHSDischrgConstMode.h"
#include "unity.h"
...
void test_BDRV_setHSDischrgConstMode(void)
{
