/**
    * @file test/unitTest/TEST_BDRV_setHSDischrgSeqMode/test/test_BDRV_setHSDischrgSeqMode.c
    * @brief Unit tests for BDRV_setHSDischrgSeqMode.
    *
    * @anchor UT_BDRV_setHSDischrgSeqMode
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setHSDischrgSeqMode.
    */
    
#include "BDRV_setHSDischrgSeqMode.h"
#include "unity.h"
...
void test_BDRV_setHSDischrgSeqMode(void)
{
