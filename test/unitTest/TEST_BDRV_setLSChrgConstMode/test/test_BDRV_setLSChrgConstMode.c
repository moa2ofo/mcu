/**
    * @file test/unitTest/TEST_BDRV_setLSChrgConstMode/test/test_BDRV_setLSChrgConstMode.c
    * @brief Unit tests for BDRV_setLSChrgConstMode.
    *
    * @anchor UT_BDRV_setLSChrgConstMode
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setLSChrgConstMode.
    */
    
#include "BDRV_setLSChrgConstMode.h"
#include "unity.h"
...
void test_BDRV_setLSChrgConstMode(void)
{
