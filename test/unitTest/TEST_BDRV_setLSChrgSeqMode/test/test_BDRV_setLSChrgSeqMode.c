/**
    * @file test/unitTest/TEST_BDRV_setLSChrgSeqMode/test/test_BDRV_setLSChrgSeqMode.c
    * @brief Unit tests for BDRV_setLSChrgSeqMode.
    *
    * @anchor UT_BDRV_setLSChrgSeqMode
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setLSChrgSeqMode.
    */
    
#include "BDRV_setLSChrgSeqMode.h"
#include "unity.h"
...
void test_BDRV_setLSChrgSeqMode(void)
{
