/**
    * @file test/unitTest/TEST_BDRV_setLSDischrgConstMode/test/test_BDRV_setLSDischrgConstMode.c
    * @brief Unit tests for BDRV_setLSDischrgConstMode.
    *
    * @anchor UT_BDRV_setLSDischrgConstMode
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setLSDischrgConstMode.
    */
    
#include "BDRV_setLSDischrgConstMode.h"
#include "unity.h"
...
void test_BDRV_setLSDischrgConstMode(void)
{
