/**
    * @file test/unitTest/TEST_BDRV_setLSDischrgSeqMode/test/test_BDRV_setLSDischrgSeqMode.c
    * @brief Unit tests for BDRV_setLSDischrgSeqMode.
    *
    * @anchor UT_BDRV_setLSDischrgSeqMode
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setLSDischrgSeqMode.
    */
    
#include "BDRV_setLSDischrgSeqMode.h"
#include "unity.h"
...
void test_BDRV_setLSDischrgSeqMode(void)
{
