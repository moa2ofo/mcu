/**
    * @file test/unitTest/TEST_BDRV_setPh1ZCFallIntNodePtr/test/test_BDRV_setPh1ZCFallIntNodePtr.c
    * @brief Unit tests for BDRV_setPh1ZCFallIntNodePtr.
    *
    * @anchor UT_BDRV_setPh1ZCFallIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setPh1ZCFallIntNodePtr.
    */
...
void test_BDRV_setPh1ZCFallIntNodePtr(void)
{
