/**
    * @file test/unitTest/TEST_BDRV_setPh1ZCRiseIntNodePtr/test/test_BDRV_setPh1ZCRiseIntNodePtr.c
    * @brief Unit tests for BDRV_setPh1ZCRiseIntNodePtr.
    *
    * @anchor UT_BDRV_setPh1ZCRiseIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setPh1ZCRiseIntNodePtr.
    */
...
void test_BDRV_setPh1ZCRiseIntNodePtr(void)
{
