/**
    * @file test/unitTest/TEST_BDRV_setPh2ZCFallIntNodePtr/test/test_BDRV_setPh2ZCFallIntNodePtr.c
    * @brief Unit tests for BDRV_setPh2ZCFallIntNodePtr.
    *
    * @anchor UT_BDRV_setPh2ZCFallIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setPh2ZCFallIntNodePtr.
    */
...
void test_BDRV_setPh2ZCFallIntNodePtr(void)
{
