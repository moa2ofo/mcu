/**
    * @file test/unitTest/TEST_BDRV_setPh2ZCRiseIntNodePtr/test/test_BDRV_setPh2ZCRiseIntNodePtr.c
    * @brief Unit tests for BDRV_setPh2ZCRiseIntNodePtr.
    *
    * @anchor UT_BDRV_setPh2ZCRiseIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setPh2ZCRiseIntNodePtr.
    */
...
void test_BDRV_setPh2ZCRiseIntNodePtr(void)
{
