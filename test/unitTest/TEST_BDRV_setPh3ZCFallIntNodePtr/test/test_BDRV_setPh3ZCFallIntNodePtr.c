/**
    * @file test/unitTest/TEST_BDRV_setPh3ZCFallIntNodePtr/test/test_BDRV_setPh3ZCFallIntNodePtr.c
    * @brief Unit tests for BDRV_setPh3ZCFallIntNodePtr.
    *
    * @anchor UT_BDRV_setPh3ZCFallIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setPh3ZCFallIntNodePtr.
    */
...
void test_BDRV_setPh3ZCFallIntNodePtr(void)
{
