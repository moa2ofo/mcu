/**
    * @file test/unitTest/TEST_BDRV_setPh3ZCRiseIntNodePtr/test/test_BDRV_setPh3ZCRiseIntNodePtr.c
    * @brief Unit tests for BDRV_setPh3ZCRiseIntNodePtr.
    *
    * @anchor UT_BDRV_setPh3ZCRiseIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * BDRV_setPh3ZCRiseIntNodePtr.
    */
...
void test_BDRV_setPh3ZCRiseIntNodePtr(void)
{
