/**
    * @file test/unitTest/TEST_BusFault_Handler/test/test_BusFault_Handler.c
    * @brief Unit tests for BusFault_Handler.
    *
    * @anchor UT_BusFault_Handler
    *
    * @details
...
void test_BusFault_Handler(void)
{
