/**
    * @file test/unitTest/TEST_CCU7_setC71BIntNodePtr/test/test_CCU7_setC71BIntNodePtr.c
    * @brief Unit tests for CCU7_setC71BIntNodePtr.
    *
    * @anchor UT_CCU7_setC71BIntNodePtr
    *
    * @details
...
#include "CCU7_setC71BIntNodePtr.h"
#include "unity.h"
...
void test_CCU7_setC71BIntNodePtr(void)
{
