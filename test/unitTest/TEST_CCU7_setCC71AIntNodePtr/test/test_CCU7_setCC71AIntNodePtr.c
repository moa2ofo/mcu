/**
    * @file test/unitTest/TEST_CCU7_setCC71AIntNodePtr/test/test_CCU7_setCC71AIntNodePtr.c
    * @brief Unit tests for CCU7_setCC71AIntNodePtr.
    *
    * @anchor UT_CCU7_setCC71AIntNodePtr
    *
    * @details
...
#include "CCU7_setCC71AIntNodePtr.h"
#include "unity.h"
...
void test_CCU7_setCC71AIntNodePtr(void)
{
