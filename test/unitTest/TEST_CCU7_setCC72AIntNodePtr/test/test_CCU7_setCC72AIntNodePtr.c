/**
    * @file test/unitTest/TEST_CCU7_setCC72AIntNodePtr/test/test_CCU7_setCC72AIntNodePtr.c
    * @brief Unit tests for CCU7_setCC72AIntNodePtr.
    *
    * @anchor UT_CCU7_setCC72AIntNodePtr
    *
    * @details
...
#include "CCU7_setCC72AIntNodePtr.h"
#include "unity.h"
...
void test_CCU7_setCC72AIntNodePtr(void)
{
