/**
    * @file test/unitTest/TEST_CCU7_setCHEIntNodePtr/test/test_CCU7_setCHEIntNodePtr.c
    * @brief Unit tests for CCU7_setCHEIntNodePtr.
    *
    * @anchor UT_CCU7_setCHEIntNodePtr
    *
    * @details
...
#include "CCU7_setCHEIntNodePtr.h"
#include "unity.h"
...
void test_CCU7_setCHEIntNodePtr(void)
{
