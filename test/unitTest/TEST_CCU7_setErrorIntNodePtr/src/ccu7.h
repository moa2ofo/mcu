...
** V0.3.1: 2021-02-02, JO:   EP-555: Applied split of register fields         **
**                           T12MODEN, T13MODEN, PSL                          **
** V0.3.2: 2021-02-02, JO:   EP-593: Applied renaming of CCU7_DT_CLK to       **
**                           CCU7_DT_CLK_MHz                                  **
**                           Corrected functions CCU7_setDeadTime_ns and      **
**                           CCU7_getDeadTime_ns to use the correct clock     **
** V0.3.3: 2021-02-10, JO:   EP-696: Changed from anonymous to named typedefs **
**                           to prevent MISRA warning                         **
** V0.3.4: 2021-02-19, JO:   EP-709: Corrected functions CCU7_disModule,      **
**                           CCU7_getHallPatternSampled, and                  **
**                           CCU7_setT13Modulation                            **
** V0.3.5: 2021-03-05, JO:   EP-730: Removed leading 't' in enum values       **
...
** V0.3.7: 2021-04-23, BG:   EP-779: Corrected typos                          **
** V0.3.8: 2021-11-12, JO:   EP-937: Updated copyright and branding           **
** V0.3.9: 2022-06-23, JO:   EP-1150: Removed ARMCC V6.18 warnings            **
** V0.4.0: 2022-11-17, JO:   EP-1342: Updated enum documentation to remove    **
**                           doxygen warning                                  **
** V0.5.0: 2024-06-03, JO:   EP-1388: Added functions for trap mode           **
 ...
 *  \brief This enum lists the CCU7 Multi Channel Mode Switching Synchronization.
 ...
 *  with a relation to the constant clock value given in CCU7_DT_CLK_MHz.
 ...
 *  If the input deadtime is not given in multiple of the CCU7_DT_CLK_MHz, the deadtime will be rounded up to the next possible value,
 ...
 *  The dead time in nano seconds related to the constant clock CCU7_DT_CLK_MHz.
