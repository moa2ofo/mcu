/**
    * @file test/unitTest/TEST_CCU7_setErrorIntNodePtr/test/test_CCU7_setErrorIntNodePtr.c
    * @brief Unit tests for CCU7_setErrorIntNodePtr.
    *
    * @anchor UT_CCU7_setErrorIntNodePtr
    *
    * @details
...
#include "CCU7_setErrorIntNodePtr.h"
#include "unity.h"
...
void test_CCU7_setErrorIntNodePtr(void)
{
