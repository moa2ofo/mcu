/**
    * @file test/unitTest/TEST_CCU7_setT13IntNodePtr/test/test_CCU7_setT13IntNodePtr.c
    * @brief Unit tests for CCU7_setT13IntNodePtr.
    *
    * @anchor UT_CCU7_setT13IntNodePtr
    *
    * @details
...
#include "CCU7_setT13IntNodePtr.h"
#include "unity.h"
...
void test_CCU7_setT13IntNodePtr(void)
{
