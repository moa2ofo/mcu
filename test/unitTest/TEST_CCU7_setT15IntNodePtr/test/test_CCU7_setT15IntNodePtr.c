/**
    * @file test/unitTest/TEST_CCU7_setT15IntNodePtr/test/test_CCU7_setT15IntNodePtr.c
    * @brief Unit tests for CCU7_setT15IntNodePtr.
    *
    * @anchor UT_CCU7_setT15IntNodePtr
    *
    * @details
...
#include "CCU7_setT15IntNodePtr.h"
#include "unity.h"
...
void test_CCU7_setT15IntNodePtr(void)
{
