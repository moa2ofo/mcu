/**
    * @file test/unitTest/TEST_CCU7_setT16IntNodePtr/test/test_CCU7_setT16IntNodePtr.c
    * @brief Unit tests for CCU7_setT16IntNodePtr.
    *
    * @anchor UT_CCU7_setT16IntNodePtr
    *
    * @details
...
#include "CCU7_setT16IntNodePtr.h"
#include "unity.h"
...
void test_CCU7_setT16IntNodePtr(void)
{
