/**
    * @file test/unitTest/TEST_CSACSC_setOverCurrIntNodePtr/test/test_CSACSC_setOverCurrIntNodePtr.c
    * @brief Unit tests for CSACSC_setOverCurrIntNodePtr.
    *
    * @anchor UT_CSACSC_setOverCurrIntNodePtr
    *
    * @details
...
void test_CSACSC_setOverCurrIntNodePtr(void)
{
