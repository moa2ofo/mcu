/**
    * @file test/unitTest/TEST_CSACSC_setParamErrorIntNodePtr/test/test_CSACSC_setParamErrorIntNodePtr.c
    * @brief Unit tests for CSACSC_setParamErrorIntNodePtr.
    *
    * @anchor UT_CSACSC_setParamErrorIntNodePtr
    *
    * @details
...
void test_CSACSC_setParamErrorIntNodePtr(void)
{
