/**
    * @file test/unitTest/TEST_CSACSC_startCalibration/test/test_CSACSC_startCalibration.c
    * @brief Unit tests for CSACSC_startCalibration.
    *
    * @anchor UT_CSACSC_startCalibration
    *
    * @details
...
#include "CSACSC_startCalibration.h"
#include "unity.h"
...
void test_CSACSC_startCalibration(void)
{
