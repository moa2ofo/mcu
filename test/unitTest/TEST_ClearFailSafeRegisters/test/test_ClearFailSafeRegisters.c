/**
    * @file test/unitTest/TEST_ClearFailSafeRegisters/test/test_ClearFailSafeRegisters.c
    * @brief Unit tests for ClearFailSafeRegisters.
    *
    * @anchor UT_ClearFailSafeRegisters
    *
    * @details
...
#include "ClearFailSafeRegisters.h"
#include "unity.h"
...
void test_ClearFailSafeRegisters(void)
{
