/**
    * @file test/unitTest/TEST_DMA_resetChannel/test/test_DMA_resetChannel.c
    * @brief Unit tests for DMA_resetChannel.
    *
    * @anchor UT_DMA_resetChannel
    *
    * @details
...
void test_DMA_resetChannel(void)
{
