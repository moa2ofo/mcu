/**
    * @file test/unitTest/TEST_DMA_setBasicTransfer/test/test_DMA_setBasicTransfer.c
    * @brief Unit tests for DMA_setBasicTransfer.
    *
    * @anchor UT_DMA_setBasicTransfer
    *
    * @details
...
#include "DMA_setBasicTransfer.h"
#include "unity.h"
...
void test_DMA_setBasicTransfer(void)
{
