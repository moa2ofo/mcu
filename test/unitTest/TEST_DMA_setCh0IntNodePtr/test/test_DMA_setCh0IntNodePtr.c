/**
    * @file test/unitTest/TEST_DMA_setCh0IntNodePtr/test/test_DMA_setCh0IntNodePtr.c
    * @brief Unit tests for DMA_setCh0IntNodePtr.
    *
    * @anchor UT_DMA_setCh0IntNodePtr
    *
    * @details
...
#include "DMA_setCh0IntNodePtr.h"
#include "unity.h"
...
void test_DMA_setCh0IntNodePtr(void)
{
