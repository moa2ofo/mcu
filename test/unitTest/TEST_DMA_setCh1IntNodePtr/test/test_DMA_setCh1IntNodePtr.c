/**
    * @file test/unitTest/TEST_DMA_setCh1IntNodePtr/test/test_DMA_setCh1IntNodePtr.c
    * @brief Unit tests for DMA_setCh1IntNodePtr.
    *
    * @anchor UT_DMA_setCh1IntNodePtr
    *
    * @details
...
#include "DMA_setCh1IntNodePtr.h"
#include "unity.h"
...
void test_DMA_setCh1IntNodePtr(void)
{
