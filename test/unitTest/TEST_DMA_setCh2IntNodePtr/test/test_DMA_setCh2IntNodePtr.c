/**
    * @file test/unitTest/TEST_DMA_setCh2IntNodePtr/test/test_DMA_setCh2IntNodePtr.c
    * @brief Unit tests for DMA_setCh2IntNodePtr.
    *
    * @anchor UT_DMA_setCh2IntNodePtr
    *
    * @details
...
#include "DMA_setCh2IntNodePtr.h"
#include "unity.h"
...
void test_DMA_setCh2IntNodePtr(void)
{
