/**
    * @file test/unitTest/TEST_DMA_setCh3IntNodePtr/test/test_DMA_setCh3IntNodePtr.c
    * @brief Unit tests for DMA_setCh3IntNodePtr.
    *
    * @anchor UT_DMA_setCh3IntNodePtr
    *
    * @details
...
#include "DMA_setCh3IntNodePtr.h"
#include "unity.h"
...
void test_DMA_setCh3IntNodePtr(void)
{
