/**
    * @file test/unitTest/TEST_DMA_setCh5IntNodePtr/test/test_DMA_setCh5IntNodePtr.c
    * @brief Unit tests for DMA_setCh5IntNodePtr.
    *
    * @anchor UT_DMA_setCh5IntNodePtr
    *
    * @details
...
#include "DMA_setCh5IntNodePtr.h"
#include "unity.h"
...
void test_DMA_setCh5IntNodePtr(void)
{
