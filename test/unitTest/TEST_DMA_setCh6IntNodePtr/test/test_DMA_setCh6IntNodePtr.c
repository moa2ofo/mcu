/**
    * @file test/unitTest/TEST_DMA_setCh6IntNodePtr/test/test_DMA_setCh6IntNodePtr.c
    * @brief Unit tests for DMA_setCh6IntNodePtr.
    *
    * @anchor UT_DMA_setCh6IntNodePtr
    *
    * @details
...
#include "DMA_setCh6IntNodePtr.h"
#include "unity.h"
...
void test_DMA_setCh6IntNodePtr(void)
{
