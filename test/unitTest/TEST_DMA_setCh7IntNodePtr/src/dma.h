...
** V0.3.2: 2022-11-17, JO:   EP-1342: Updated enum documentation to remove    **
**                           doxygen warning                                  **
** V0.3.3: 2024-11-05, JO:   EP-1494: Updated license                         **
*******************************************************************************/
 ...
 *  \note You can use this type via 'tDMA_transferSize' or 'enum DMA_transferSize'
 */
 ...
 *  \note You can use this type via 'tDMA_incrementSize' or 'enum DMA_incrementSize'
 */
 ...
 *  \note You can use this type via 'tDMA_incrementMode' or 'enum DMA_incrementMode'
 */
 ...
 *  \note You can use this type via 'tDMA_cycleType' or 'enum DMA_cycleType'
 */
