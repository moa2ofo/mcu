/**
    * @file test/unitTest/TEST_DMA_setCh7IntNodePtr/test/test_DMA_setCh7IntNodePtr.c
    * @brief Unit tests for DMA_setCh7IntNodePtr.
    *
    * @anchor UT_DMA_setCh7IntNodePtr
    *
    * @details
...
#include "DMA_setCh7IntNodePtr.h"
#include "unity.h"
...
void test_DMA_setCh7IntNodePtr(void)
{
