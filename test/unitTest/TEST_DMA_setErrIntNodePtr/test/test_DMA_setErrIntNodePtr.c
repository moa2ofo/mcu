/**
    * @file test/unitTest/TEST_DMA_setErrIntNodePtr/test/test_DMA_setErrIntNodePtr.c
    * @brief Unit tests for DMA_setErrIntNodePtr.
    *
    * @anchor UT_DMA_setErrIntNodePtr
    *
    * @details
...
#include "DMA_setErrIntNodePtr.h"
#include "unity.h"
...
void test_DMA_setErrIntNodePtr(void)
{
