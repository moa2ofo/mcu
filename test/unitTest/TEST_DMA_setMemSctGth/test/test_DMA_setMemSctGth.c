/**
    * @file test/unitTest/TEST_DMA_setMemSctGth/test/test_DMA_setMemSctGth.c
    * @brief Unit tests for DMA_setMemSctGth.
    *
    * @anchor UT_DMA_setMemSctGth
    *
    * @details
...
void test_DMA_setMemSctGth(void)
{
