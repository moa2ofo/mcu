/**
    * @file test/unitTest/TEST_DMA_setPerSctGth/test/test_DMA_setPerSctGth.c
    * @brief Unit tests for DMA_setPerSctGth.
    *
    * @anchor UT_DMA_setPerSctGth
    *
    * @details
...
void test_DMA_setPerSctGth(void)
{
