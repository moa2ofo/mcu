/**
    * @file test/unitTest/TEST_DMA_setTaskSctGth/test/test_DMA_setTaskSctGth.c
    * @brief Unit tests for DMA_setTaskSctGth.
    *
    * @anchor UT_DMA_setTaskSctGth
    *
    * @details
...
void test_DMA_setTaskSctGth(void)
{
