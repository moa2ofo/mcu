/**
    * @file test/unitTest/TEST_GPT12_setCapRelIntNodePtr/test/test_GPT12_setCapRelIntNodePtr.c
    * @brief Unit tests for GPT12_setCapRelIntNodePtr.
    *
    * @anchor UT_GPT12_setCapRelIntNodePtr
    *
    * @details
...
#include "GPT12_setCapRelIntNodePtr.h"
#include "unity.h"

#include "mock_RTE_Components.h"
#include "mock_gpt12_defines.h"
...
void test_GPT12_setCapRelIntNodePtr(void)
{
