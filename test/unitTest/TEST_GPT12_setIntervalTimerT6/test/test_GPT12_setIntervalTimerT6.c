/**
    * @file test/unitTest/TEST_GPT12_setIntervalTimerT6/test/test_GPT12_setIntervalTimerT6.c
    * @brief Unit tests for GPT12_setIntervalTimerT6.
    *
    * @anchor UT_GPT12_setIntervalTimerT6
    *
    * @details
...
#include "GPT12_setIntervalTimerT6.h"
#include "unity.h"
...
void test_GPT12_setIntervalTimerT6(void)
{
