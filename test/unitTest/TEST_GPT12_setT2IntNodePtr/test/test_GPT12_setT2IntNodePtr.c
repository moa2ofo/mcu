/**
    * @file test/unitTest/TEST_GPT12_setT2IntNodePtr/test/test_GPT12_setT2IntNodePtr.c
    * @brief Unit tests for GPT12_setT2IntNodePtr.
    *
    * @anchor UT_GPT12_setT2IntNodePtr
    *
    * @details
...
#include "GPT12_setT2IntNodePtr.h"
#include "unity.h"
...
void test_GPT12_setT2IntNodePtr(void)
{
