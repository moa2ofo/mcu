...
** V0.5.5: 2020-11-12, JO:   EP-590: Removed \param none and \return none to  **
**                           avoid doxygen warning                            **
** V0.5.6: 2020-11-20, BG:   EP-610: Corrected MISRA 2012 errors              **
**                           The following rules are globally deactivated:    **
**                           - Info 774: Boolean within 'if' always evaluates **
**                             to False/True                                  **
** V0.5.7: 2020-12-18, BG:   EP-652: Corrected name of error code variable    **
** V0.5.8: 2021-04-06, BG:   EP-760: Replaced if instructions to check if the **
**                           module is enabled with preprocessor directives to**
**                           avoid compiler warnings                          **
** V0.5.9: 2021-05-06, JO:   EP-811: Corrected function name of function      **
**                           GPT12_disT2Int in declaration                    **
** V0.6.0: 2021-10-07, BG:   EP-920: Corrected frequency unit in the functions**
**                           GPT12_setIntervalTimerT3/GPT12_setIntervalTimerT6**
**                           so that the calculations of ticks are correct    **
** V0.6.1: 2021-11-12, JO:   EP-937: Updated copyright and branding           **
** V0.6.2: 2022-04-25, JO:   EP-1139: Corrected MISRA violations              **
** V0.6.3: 2024-11-05, JO:   EP-1494: Updated license                         **
*******************************************************************************/
