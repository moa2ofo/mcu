/**
    * @file test/unitTest/TEST_GPT12_setT3IntNodePtr/test/test_GPT12_setT3IntNodePtr.c
    * @brief Unit tests for GPT12_setT3IntNodePtr.
    *
    * @anchor UT_GPT12_setT3IntNodePtr
    *
    * @details
...
#include "GPT12_setT3IntNodePtr.h"
#include "unity.h"
...
void test_GPT12_setT3IntNodePtr(void)
{
