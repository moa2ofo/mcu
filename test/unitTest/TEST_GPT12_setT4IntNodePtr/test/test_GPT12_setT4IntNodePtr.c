/**
    * @file test/unitTest/TEST_GPT12_setT4IntNodePtr/test/test_GPT12_setT4IntNodePtr.c
    * @brief Unit tests for GPT12_setT4IntNodePtr.
    *
    * @anchor UT_GPT12_setT4IntNodePtr
    *
    * @details
...
#include "GPT12_setT4IntNodePtr.h"
#include "unity.h"
...
void test_GPT12_setT4IntNodePtr(void)
{
