/**
    * @file test/unitTest/TEST_GPT12_setT5IntNodePtr/test/test_GPT12_setT5IntNodePtr.c
    * @brief Unit tests for GPT12_setT5IntNodePtr.
    *
    * @anchor UT_GPT12_setT5IntNodePtr
    *
    * @details
...
#include "GPT12_setT5IntNodePtr.h"
#include "unity.h"
...
void test_GPT12_setT5IntNodePtr(void)
{
