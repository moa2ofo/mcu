/**
    * @file test/unitTest/TEST_GPT12_setT6IntNodePtr/test/test_GPT12_setT6IntNodePtr.c
    * @brief Unit tests for GPT12_setT6IntNodePtr.
    *
    * @anchor UT_GPT12_setT6IntNodePtr
    *
    * @details
...
#include "GPT12_setT6IntNodePtr.h"
#include "unity.h"
...
void test_GPT12_setT6IntNodePtr(void)
{
