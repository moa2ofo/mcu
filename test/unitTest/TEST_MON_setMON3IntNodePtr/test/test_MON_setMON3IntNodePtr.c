/**
    * @file test/unitTest/TEST_MON_setMON3IntNodePtr/test/test_MON_setMON3IntNodePtr.c
    * @brief Unit tests for MON_setMON3IntNodePtr.
    *
    * @anchor UT_MON_setMON3IntNodePtr
    *
    * @details
...
#include "MON_setMON3IntNodePtr.h"
#include "unity.h"
...
void test_MON_setMON3IntNodePtr(void)
{
