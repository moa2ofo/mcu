/**
    * @file test/unitTest/TEST_Mcu_Initialize/test/test_Mcu_Initialize.c
    * @brief Unit tests for Mcu_Initialize.
    *
    * @anchor UT_Mcu_Initialize
    *
    * @details
