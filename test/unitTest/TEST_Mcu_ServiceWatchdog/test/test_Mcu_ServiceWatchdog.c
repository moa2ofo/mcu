/**
    * @file test/unitTest/TEST_Mcu_ServiceWatchdog/test/test_Mcu_ServiceWatchdog.c
    * @brief Unit tests for Mcu_ServiceWatchdog.
    *
    * @anchor UT_Mcu_ServiceWatchdog
    *
    * @details
...
void test_Mcu_ServiceWatchdog(void)
{
