/**
    * @file test/unitTest/TEST_Mcu_ServiceWatchdogSow/test/test_Mcu_ServiceWatchdogSow.c
    * @brief Unit tests for Mcu_ServiceWatchdogSow.
    *
    * @anchor UT_Mcu_ServiceWatchdogSow
    *
    * @details
...
void test_Mcu_ServiceWatchdogSow(void)
{
