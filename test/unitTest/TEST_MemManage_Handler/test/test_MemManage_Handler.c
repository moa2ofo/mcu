/**
    * @file test/unitTest/TEST_MemManage_Handler/test/test_MemManage_Handler.c
    * @brief Unit tests for MemManage_Handler.
    *
    * @anchor UT_MemManage_Handler
    *
    * @details
...
void test_MemManage_Handler(void)
{
