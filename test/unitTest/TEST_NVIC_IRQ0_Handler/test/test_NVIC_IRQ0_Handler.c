/**
    * @file test/unitTest/TEST_NVIC_IRQ0_Handler/test/test_NVIC_IRQ0_Handler.c
    * @brief Unit tests for NVIC_IRQ0_Handler.
    *
    * @anchor UT_NVIC_IRQ0_Handler
    *
    * @details
...
void test_NVIC_IRQ0_Handler(void)
{
