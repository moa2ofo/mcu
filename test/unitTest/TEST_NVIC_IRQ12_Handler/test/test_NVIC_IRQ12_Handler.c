/**
    * @file test/unitTest/TEST_NVIC_IRQ12_Handler/test/test_NVIC_IRQ12_Handler.c
    * @brief Unit tests for NVIC_IRQ12_Handler.
    *
    * @anchor UT_NVIC_IRQ12_Handler
    *
    * @details
...
void test_NVIC_IRQ12_Handler(void)
{
