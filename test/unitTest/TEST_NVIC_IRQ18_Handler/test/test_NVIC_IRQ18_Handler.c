/**
    * @file test/unitTest/TEST_NVIC_IRQ18_Handler/test/test_NVIC_IRQ18_Handler.c
    * @brief Unit tests for NVIC_IRQ18_Handler.
    *
    * @anchor UT_NVIC_IRQ18_Handler
    *
    * @details
...
void test_NVIC_IRQ18_Handler(void)
{
