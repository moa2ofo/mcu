/**
    * @file test/unitTest/TEST_NVIC_IRQ22_Handler/test/test_NVIC_IRQ22_Handler.c
    * @brief Unit tests for NVIC_IRQ22_Handler.
    *
    * @anchor UT_NVIC_IRQ22_Handler
    *
    * @details
...
void test_NVIC_IRQ22_Handler(void)
{
