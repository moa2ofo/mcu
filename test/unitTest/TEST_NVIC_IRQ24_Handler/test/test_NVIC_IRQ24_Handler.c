/**
    * @file test/unitTest/TEST_NVIC_IRQ24_Handler/test/test_NVIC_IRQ24_Handler.c
    * @brief Unit tests for NVIC_IRQ24_Handler.
    *
    * @anchor UT_NVIC_IRQ24_Handler
    *
    * @details
...
void test_NVIC_IRQ24_Handler(void)
{
