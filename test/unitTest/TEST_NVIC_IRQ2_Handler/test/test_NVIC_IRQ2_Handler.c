/**
    * @file test/unitTest/TEST_NVIC_IRQ2_Handler/test/test_NVIC_IRQ2_Handler.c
    * @brief Unit tests for NVIC_IRQ2_Handler.
    *
    * @anchor UT_NVIC_IRQ2_Handler
    *
    * @details
...
void test_NVIC_IRQ2_Handler(void)
{
