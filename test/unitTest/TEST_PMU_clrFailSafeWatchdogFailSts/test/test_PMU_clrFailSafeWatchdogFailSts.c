/**
    * @file test/unitTest/TEST_PMU_clrFailSafeWatchdogFailSts/test/test_PMU_clrFailSafeWatchdogFailSts.c
    * @brief Unit tests for PMU_clrFailSafeWatchdogFailSts.
    *
    * @anchor UT_PMU_clrFailSafeWatchdogFailSts
    *
    * @details
...
#include "PMU_clrFailSafeWatchdogFailSts.h"
#include "unity.h"
...
void test_PMU_clrFailSafeWatchdogFailSts(void)
{
