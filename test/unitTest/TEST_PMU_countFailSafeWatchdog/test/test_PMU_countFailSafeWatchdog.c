/**
    * @file test/unitTest/TEST_PMU_countFailSafeWatchdog/test/test_PMU_countFailSafeWatchdog.c
    * @brief Unit tests for PMU_countFailSafeWatchdog.
    *
    * @anchor UT_PMU_countFailSafeWatchdog
    *
    * @details
...
#include "PMU_countFailSafeWatchdog.h"
#include "unity.h"
...
void test_PMU_countFailSafeWatchdog(void)
{
