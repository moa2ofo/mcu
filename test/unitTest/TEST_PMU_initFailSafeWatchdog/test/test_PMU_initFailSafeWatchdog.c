/**
    * @file test/unitTest/TEST_PMU_initFailSafeWatchdog/test/test_PMU_initFailSafeWatchdog.c
    * @brief Unit tests for PMU_initFailSafeWatchdog.
    *
    * @anchor UT_PMU_initFailSafeWatchdog
    *
    * @details
...
void test_PMU_initFailSafeWatchdog(void)
{
