...
**                           doxygen warning                                  **
** V0.5.8: 2023-03-01, BG:   EP-1335: Removed the unnecessary while loop for  **
**                           the fail-safe watchdog initialization            **
**                           Moved the clearance of the WD fail status bit    **
**                           from PMU_serviceFailSafeWatchdog() to            **
**                           PMU_initFailSafeWatchdog()                       **
** V0.5.9: 2023-04-04, PS:   EP-1141: Correct MISRA warnings                  **
** V0.6.0: 2023-04-26, BG:   EP-1428: Removed the functions PMU_enStartCfg()  **
**                           and PMU_disStartCfg since the bitfield CONF in   **
**                           the register START_CONFIG is not available in the**
**                           SVD file v1.0.0                                  **
** V0.6.1: 2024-11-05, JO:   EP-1494: Updated license                         **
*******************************************************************************/
