/**
    * @file test/unitTest/TEST_PMU_serviceFailSafeWatchdogSOW/test/test_PMU_serviceFailSafeWatchdogSOW.c
    * @brief Unit tests for PMU_serviceFailSafeWatchdogSOW.
    *
    * @anchor UT_PMU_serviceFailSafeWatchdogSOW
    *
    * @details
...
void test_PMU_serviceFailSafeWatchdogSOW(void)
{
