/**
    * @file test/unitTest/TEST_PMU_setVDDCOvervoltageIntNodePtr/test/test_PMU_setVDDCOvervoltageIntNodePtr.c
    * @brief Unit tests for PMU_setVDDCOvervoltageIntNodePtr.
    *
    * @anchor UT_PMU_setVDDCOvervoltageIntNodePtr
    *
    * @details
...
void test_PMU_setVDDCOvervoltageIntNodePtr(void)
{
