#ifndef TEST_PMU_SETVDDEXTOVERTEMPERATUREINTNODEPTR_H
#define TEST_PMU_SETVDDEXTOVERTEMPERATUREINTNODEPTR_H
...
#endif /* TEST_PMU_SETVDDEXTOVERTEMPERATUREINTNODEPTR_H */
