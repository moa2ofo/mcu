/**
    * @file test/unitTest/TEST_PMU_setVDDEXTOvertemperatureIntNodePtr/test/test_PMU_setVDDEXTOvertemperatureIntNodePtr.c
    * @brief Unit tests for PMU_setVDDEXTOvertemperatureIntNodePtr.
    *
    * @anchor UT_PMU_setVDDEXTOvertemperatureIntNodePtr
    *
    * @details
...
#include "PMU_setVDDEXTOvertemperatureIntNodePtr.h"
#include "unity.h"
...
void test_PMU_setVDDEXTOvertemperatureIntNodePtr(void)
{
