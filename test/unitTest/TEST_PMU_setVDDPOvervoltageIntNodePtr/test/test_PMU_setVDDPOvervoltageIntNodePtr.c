/**
    * @file test/unitTest/TEST_PMU_setVDDPOvervoltageIntNodePtr/test/test_PMU_setVDDPOvervoltageIntNodePtr.c
    * @brief Unit tests for PMU_setVDDPOvervoltageIntNodePtr.
    *
    * @anchor UT_PMU_setVDDPOvervoltageIntNodePtr
    *
    * @details
...
void test_PMU_setVDDPOvervoltageIntNodePtr(void)
{
