/**
    * @file test/unitTest/TEST_PMU_setVDDPUndervoltageWarnIntNodePtr/test/test_PMU_setVDDPUndervoltageWarnIntNodePtr.c
    * @brief Unit tests for PMU_setVDDPUndervoltageWarnIntNodePtr.
    *
    * @anchor UT_PMU_setVDDPUndervoltageWarnIntNodePtr
    *
    * @details
...
void test_PMU_setVDDPUndervoltageWarnIntNodePtr(void)
{
