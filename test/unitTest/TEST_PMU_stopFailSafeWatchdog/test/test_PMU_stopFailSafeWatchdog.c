/**
    * @file test/unitTest/TEST_PMU_stopFailSafeWatchdog/test/test_PMU_stopFailSafeWatchdog.c
    * @brief Unit tests for PMU_stopFailSafeWatchdog.
    *
    * @anchor UT_PMU_stopFailSafeWatchdog
    *
    * @details
...
#include "PMU_stopFailSafeWatchdog.h"
#include "unity.h"
...
void test_PMU_stopFailSafeWatchdog(void)
{
