/**
    * @file test/unitTest/TEST_PendSV_Handler/test/test_PendSV_Handler.c
    * @brief Unit tests for PendSV_Handler.
    *
    * @anchor UT_PendSV_Handler
    *
    * @details
