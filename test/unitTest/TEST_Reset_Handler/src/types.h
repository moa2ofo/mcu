...
**                           is not triggered                                 **
** V0.3.3: 2020-10-21, BG:   EP-539: Added return code when the modules are   **
**                           not enabled in CW                                **
** V0.3.4: 2020-10-21, BG:   EP-595: Added return code for Safe Shutdown      **
** V0.3.5: 2021-02-26, BG:   EP-701: Added return codes when the SOW is not   **
**                           enabled                                          **
** V0.3.6: 2021-03-01, BG:   EP-716: Added compatibility with IAR compiler    **
** V0.3.7: 2021-06-07, BG:   EP-815: Added a return code when several errors  **
**                           occur in the BDRV init, so that the ORed error   **
**                           code is consistent in TLE_init()                 **
** V0.3.8: 2021-08-04, JO:   EP-897: Added else to define INLINE for other    **
**                           compilers as 'static inline'                     **
** V0.3.9: 2021-11-12, JO:   EP-937: Updated copyright and branding           **
** V0.4.0: 2022-06-23, JO:   EP-1150: Removed ARMCC V6.18 warnings,           **
**                           changed from inline to __inline for C90 support  **
** V0.4.1: 2022-10-14, PS:   EP-819: Replaced the INLINE define with the      **
**                           CMSIS related __STATIC_INLINE define             **
** V0.4.2: 2022-10-25, PS:   EP-1333: Replaced boolean type with bool         **
** V0.4.3: 2024-11-05, JO:   EP-1494: Updated license                         **
*******************************************************************************/
 ...
 */
#define ERR_LOG_CODE_MODULE_DISABLED_IN_CW  (-116)  /**< \brief One or more modules disabled in Config Wizard */
...
#define ERR_LOG_CODE_SOW_DISABLED           (-107)  /**< \brief No Short Open Window activated */
#define ERR_LOG_CODE_PARAM_OUT_OF_RANGE     (-122)  /**< \brief Parameter out of range */
#define ERR_LOG_CODE_SAFE_SHUTDOWN_ACTIVE   (-118)  /**< \brief Safe Shutdown active */
#define ERR_LOG_CODE_ERR_BDRV_INIT          (-114)  /**< \brief Several errors in the BDRV initialization */
