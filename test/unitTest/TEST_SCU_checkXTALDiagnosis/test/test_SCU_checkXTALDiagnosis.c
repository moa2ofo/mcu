/**
    * @file test/unitTest/TEST_SCU_checkXTALDiagnosis/test/test_SCU_checkXTALDiagnosis.c
    * @brief Unit tests for SCU_checkXTALDiagnosis.
    *
    * @anchor UT_SCU_checkXTALDiagnosis
    *
    * @details
...
#include "SCU_checkXTALDiagnosis.h"
#include "unity.h"
...
void test_SCU_checkXTALDiagnosis(void)
{
