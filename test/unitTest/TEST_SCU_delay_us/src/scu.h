...
** V0.5.3: 2022-04-19, JO:   EP-1002: Moved declaration of u32_currentTime_ms **
**                           and u32_currentTime_ms to remove ARMCC V5        **
**                           compiler warning                                 **
** V0.5.4: 2022-06-28, JO:   EP-1021: Added timeout for PLL initialization    **
** V0.5.5: 2023-05-09, BG:   EP-1428: To comply with the latest UM version:   **
**                           - Replaced the functions                         **
**                           SCU_enterStopModeWithResetWakeup() and           **
**                           SCU_enterStopModeWithoutResetWakeup() with one   **
**                           single function SCU_enterStopMode()              **
**                           - Updated the function SCU_enterSleepMode()      **
** V0.5.6: 2024-11-05, JO:   EP-1494: Updated license                         **
*******************************************************************************/
