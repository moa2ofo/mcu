/**
    * @file test/unitTest/TEST_SCU_delay_us/test/test_SCU_delay_us.c
    * @brief Unit tests for SCU_delay_us.
    *
    * @anchor UT_SCU_delay_us
    *
    * @details
