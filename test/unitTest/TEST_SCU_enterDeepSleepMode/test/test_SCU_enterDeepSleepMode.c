/**
    * @file test/unitTest/TEST_SCU_enterDeepSleepMode/test/test_SCU_enterDeepSleepMode.c
    * @brief Unit tests for SCU_enterDeepSleepMode.
    *
    * @anchor UT_SCU_enterDeepSleepMode
    *
    * @details
...
#include "SCU_enterDeepSleepMode.h"
#include "unity.h"
...
void test_SCU_enterDeepSleepMode(void)
{
