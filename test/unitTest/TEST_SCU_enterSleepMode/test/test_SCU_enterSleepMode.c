/**
    * @file test/unitTest/TEST_SCU_enterSleepMode/test/test_SCU_enterSleepMode.c
    * @brief Unit tests for SCU_enterSleepMode.
    *
    * @anchor UT_SCU_enterSleepMode
    *
    * @details
...
void test_SCU_enterSleepMode(void)
{
