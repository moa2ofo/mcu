/**
    * @file test/unitTest/TEST_SCU_enterStopMode/test/test_SCU_enterStopMode.c
    * @brief Unit tests for SCU_enterStopMode.
    *
    * @anchor UT_SCU_enterStopMode
    *
    * @details
...
void test_SCU_enterStopMode(void)
{
