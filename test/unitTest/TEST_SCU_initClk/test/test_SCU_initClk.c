/**
    * @file test/unitTest/TEST_SCU_initClk/test/test_SCU_initClk.c
    * @brief Unit tests for SCU_initClk.
    *
    * @anchor UT_SCU_initClk
    *
    * @details
