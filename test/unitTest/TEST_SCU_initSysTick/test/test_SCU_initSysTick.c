/**
    * @file test/unitTest/TEST_SCU_initSysTick/test/test_SCU_initSysTick.c
    * @brief Unit tests for SCU_initSysTick.
    *
    * @anchor UT_SCU_initSysTick
    *
    * @details
...
void test_SCU_initSysTick(void)
{
