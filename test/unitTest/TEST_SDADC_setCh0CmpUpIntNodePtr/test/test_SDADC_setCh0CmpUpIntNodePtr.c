/**
    * @file test/unitTest/TEST_SDADC_setCh0CmpUpIntNodePtr/test/test_SDADC_setCh0CmpUpIntNodePtr.c
    * @brief Unit tests for SDADC_setCh0CmpUpIntNodePtr.
    *
    * @anchor UT_SDADC_setCh0CmpUpIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * SDADC_setCh0CmpUpIntNodePtr.
    */
...
void test_SDADC_setCh0CmpUpIntNodePtr(void)
{
