/**
    * @file test/unitTest/TEST_SDADC_setCh0ResIntNodePtr/test/test_SDADC_setCh0ResIntNodePtr.c
    * @brief Unit tests for SDADC_setCh0ResIntNodePtr.
    *
    * @anchor UT_SDADC_setCh0ResIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * SDADC_setCh0ResIntNodePtr.
    */
    
#include "SDADC_setCh0ResIntNodePtr.h"
#include "unity.h"
...
void test_SDADC_setCh0ResIntNodePtr(void)
{
