/**
    * @file test/unitTest/TEST_SDADC_setCh1CmpLoIntNodePtr/test/test_SDADC_setCh1CmpLoIntNodePtr.c
    * @brief Unit tests for SDADC_setCh1CmpLoIntNodePtr.
    *
    * @anchor UT_SDADC_setCh1CmpLoIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * SDADC_setCh1CmpLoIntNodePtr.
    */
...
void test_SDADC_setCh1CmpLoIntNodePtr(void)
{
