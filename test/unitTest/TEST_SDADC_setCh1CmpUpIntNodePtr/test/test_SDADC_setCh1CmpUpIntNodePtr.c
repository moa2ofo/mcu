/**
    * @file test/unitTest/TEST_SDADC_setCh1CmpUpIntNodePtr/test/test_SDADC_setCh1CmpUpIntNodePtr.c
    * @brief Unit tests for SDADC_setCh1CmpUpIntNodePtr.
    *
    * @anchor UT_SDADC_setCh1CmpUpIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * SDADC_setCh1CmpUpIntNodePtr.
    */
...
void test_SDADC_setCh1CmpUpIntNodePtr(void)
{
