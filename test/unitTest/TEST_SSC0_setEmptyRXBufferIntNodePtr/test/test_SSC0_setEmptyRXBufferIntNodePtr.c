/**
    * @file test/unitTest/TEST_SSC0_setEmptyRXBufferIntNodePtr/test/test_SSC0_setEmptyRXBufferIntNodePtr.c
    * @brief Unit tests for SSC0_setEmptyRXBufferIntNodePtr.
    *
    * @anchor UT_SSC0_setEmptyRXBufferIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * SSC0_setEmptyRXBufferIntNodePtr.
    */
...
void test_SSC0_setEmptyRXBufferIntNodePtr(void)
{
