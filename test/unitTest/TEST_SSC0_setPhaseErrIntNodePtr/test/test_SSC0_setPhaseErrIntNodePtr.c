/**
    * @file test/unitTest/TEST_SSC0_setPhaseErrIntNodePtr/test/test_SSC0_setPhaseErrIntNodePtr.c
    * @brief Unit tests for SSC0_setPhaseErrIntNodePtr.
    *
    * @anchor UT_SSC0_setPhaseErrIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * SSC0_setPhaseErrIntNodePtr.
    */
    
#include "SSC0_setPhaseErrIntNodePtr.h"
#include "unity.h"
...
void test_SSC0_setPhaseErrIntNodePtr(void)
{
