/**
    * @file test/unitTest/TEST_SSC0_setRXErrIntNodePtr/test/test_SSC0_setRXErrIntNodePtr.c
    * @brief Unit tests for SSC0_setRXErrIntNodePtr.
    *
    * @anchor UT_SSC0_setRXErrIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * SSC0_setRXErrIntNodePtr.
    */
    
#include "SSC0_setRXErrIntNodePtr.h"
#include "unity.h"
...
void test_SSC0_setRXErrIntNodePtr(void)
{
