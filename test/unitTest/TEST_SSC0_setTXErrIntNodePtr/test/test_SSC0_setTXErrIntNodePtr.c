/**
    * @file test/unitTest/TEST_SSC0_setTXErrIntNodePtr/test/test_SSC0_setTXErrIntNodePtr.c
    * @brief Unit tests for SSC0_setTXErrIntNodePtr.
    *
    * @anchor UT_SSC0_setTXErrIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * SSC0_setTXErrIntNodePtr.
    */
    
#include "SSC0_setTXErrIntNodePtr.h"
#include "unity.h"
...
void test_SSC0_setTXErrIntNodePtr(void)
{
