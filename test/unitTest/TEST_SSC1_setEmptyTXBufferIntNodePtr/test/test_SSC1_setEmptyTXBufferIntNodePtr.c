/**
    * @file test/unitTest/TEST_SSC1_setEmptyTXBufferIntNodePtr/test/test_SSC1_setEmptyTXBufferIntNodePtr.c
    * @brief Unit tests for SSC1_setEmptyTXBufferIntNodePtr.
    *
    * @anchor UT_SSC1_setEmptyTXBufferIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * SSC1_setEmptyTXBufferIntNodePtr.
    */
...
void test_SSC1_setEmptyTXBufferIntNodePtr(void)
{
