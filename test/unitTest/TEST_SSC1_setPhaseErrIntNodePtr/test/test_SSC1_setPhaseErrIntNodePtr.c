/**
    * @file test/unitTest/TEST_SSC1_setPhaseErrIntNodePtr/test/test_SSC1_setPhaseErrIntNodePtr.c
    * @brief Unit tests for SSC1_setPhaseErrIntNodePtr.
    *
    * @anchor UT_SSC1_setPhaseErrIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * SSC1_setPhaseErrIntNodePtr.
    */
    
#include "SSC1_setPhaseErrIntNodePtr.h"
#include "unity.h"
...
void test_SSC1_setPhaseErrIntNodePtr(void)
{
