/**
    * @file test/unitTest/TEST_SSC1_setRXErrIntNodePtr/test/test_SSC1_setRXErrIntNodePtr.c
    * @brief Unit tests for SSC1_setRXErrIntNodePtr.
    *
    * @anchor UT_SSC1_setRXErrIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * SSC1_setRXErrIntNodePtr.
    */
    
#include "SSC1_setRXErrIntNodePtr.h"
#include "unity.h"
...
void test_SSC1_setRXErrIntNodePtr(void)
{
