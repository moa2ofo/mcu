/**
    * @file test/unitTest/TEST_SSC1_setTXErrIntNodePtr/test/test_SSC1_setTXErrIntNodePtr.c
    * @brief Unit tests for SSC1_setTXErrIntNodePtr.
    *
    * @anchor UT_SSC1_setTXErrIntNodePtr
    *
    * @details
    * This file contains the Unity unit test stub for the SW unit
    * SSC1_setTXErrIntNodePtr.
    */
    
#include "SSC1_setTXErrIntNodePtr.h"
#include "unity.h"
...
void test_SSC1_setTXErrIntNodePtr(void)
{
