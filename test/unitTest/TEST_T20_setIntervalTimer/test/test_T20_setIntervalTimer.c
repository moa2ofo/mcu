/**
    * @file test/unitTest/TEST_T20_setIntervalTimer/test/test_T20_setIntervalTimer.c
    * @brief Unit tests for T20_setIntervalTimer.
    *
    * @anchor UT_T20_setIntervalTimer
    *
    * @details
...
void test_T20_setIntervalTimer(void)
{
