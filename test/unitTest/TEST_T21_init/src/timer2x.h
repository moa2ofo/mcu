...
** V0.4.7: 2021-01-07, BG:   EP-664: Added APIs to get the reload/capture     **
**                           value and set the timer value for T20 and T21    **
** V0.4.8: 2021-03-17, BG:   EP-742: Renamed defines file for timer2x         **
** V0.4.9: 2021-04-06, BG:   EP-760: Replaced if instructions to check if the **
**                           module is enabled with preprocessor directives to**
**                           avoid compiler warnings                          **
** V0.5.0: 2021-11-12, JO:   EP-937: Updated copyright and branding           **
** V0.5.1: 2024-11-05, JO:   EP-1494: Updated license                         **
*******************************************************************************/
...
/** \brief Get T20 Capture/Reload Value T20.RC
 *
...
/** \brief Get T21 Capture/Reload Value T21.RC
 *
...
/** \brief Set T20 Count Value T20.CNT
 *
...
/** \brief Set T21 Count Value T21.CNT
 *
...
/** \brief Set T20 Reload/Capture Value T20.RC
 *
...
/** \brief Set T21 Reload/Capture Value T21.RC
 *
