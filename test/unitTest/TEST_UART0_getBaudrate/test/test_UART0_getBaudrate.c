/**
    * @file test/unitTest/TEST_UART0_getBaudrate/test/test_UART0_getBaudrate.c
    * @brief Unit tests for UART0_getBaudrate.
    *
    * @anchor UT_UART0_getBaudrate
    *
    * @details
...
void test_UART0_getBaudrate(void)
{
