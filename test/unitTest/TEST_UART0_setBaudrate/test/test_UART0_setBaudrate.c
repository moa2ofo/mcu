/**
    * @file test/unitTest/TEST_UART0_setBaudrate/test/test_UART0_setBaudrate.c
    * @brief Unit tests for UART0_setBaudrate.
    *
    * @anchor UT_UART0_setBaudrate
    *
    * @details
...
void test_UART0_setBaudrate(void)
{
