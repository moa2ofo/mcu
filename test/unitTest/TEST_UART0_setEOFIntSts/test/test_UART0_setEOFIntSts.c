/**
    * @file test/unitTest/TEST_UART0_setEOFIntSts/test/test_UART0_setEOFIntSts.c
    * @brief Unit tests for UART0_setEOFIntSts.
    *
    * @anchor UT_UART0_setEOFIntSts
    *
    * @details
...
void test_UART0_setEOFIntSts(void)
{
