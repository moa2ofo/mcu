/**
    * @file test/unitTest/TEST_UART0_setSyncErrIntSts/test/test_UART0_setSyncErrIntSts.c
    * @brief Unit tests for UART0_setSyncErrIntSts.
    *
    * @anchor UT_UART0_setSyncErrIntSts
    *
    * @details
...
#include "UART0_setSyncErrIntSts.h"
#include "unity.h"
...
void test_UART0_setSyncErrIntSts(void)
{
