/**
    * @file test/unitTest/TEST_UART0_setTXIntSts/test/test_UART0_setTXIntSts.c
    * @brief Unit tests for UART0_setTXIntSts.
    *
    * @anchor UT_UART0_setTXIntSts
    *
    * @details
...
void test_UART0_setTXIntSts(void)
{
