/**
    * @file test/unitTest/TEST_UART1_getBaudrate/test/test_UART1_getBaudrate.c
    * @brief Unit tests for UART1_getBaudrate.
    *
    * @anchor UT_UART1_getBaudrate
    *
    * @details
...
void test_UART1_getBaudrate(void)
{
