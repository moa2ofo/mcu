/**
    * @file test/unitTest/TEST_UART1_setEOFIntSts/test/test_UART1_setEOFIntSts.c
    * @brief Unit tests for UART1_setEOFIntSts.
    *
    * @anchor UT_UART1_setEOFIntSts
    *
    * @details
...
void test_UART1_setEOFIntSts(void)
{
