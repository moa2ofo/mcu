/**
    * @file test/unitTest/TEST_UART1_setRXIntSts/test/test_UART1_setRXIntSts.c
    * @brief Unit tests for UART1_setRXIntSts.
    *
    * @anchor UT_UART1_setRXIntSts
    *
    * @details
...
void test_UART1_setRXIntSts(void)
{
