/**
    * @file test/unitTest/TEST_UART1_setTXIntSts/test/test_UART1_setTXIntSts.c
    * @brief Unit tests for UART1_setTXIntSts.
    *
    * @anchor UT_UART1_setTXIntSts
    *
    * @details
...
void test_UART1_setTXIntSts(void)
{
