/**
    * @file test/unitTest/TEST_UARTx_setBaudrate/test/test_UARTx_setBaudrate.c
    * @brief Unit tests for UARTx_setBaudrate.
    *
    * @anchor UT_UARTx_setBaudrate
    *
    * @details
...
void test_UARTx_setBaudrate(void)
{
