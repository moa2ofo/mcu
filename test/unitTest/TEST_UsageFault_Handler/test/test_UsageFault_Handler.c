/**
    * @file test/unitTest/TEST_UsageFault_Handler/test/test_UsageFault_Handler.c
    * @brief Unit tests for UsageFault_Handler.
    *
    * @anchor UT_UsageFault_Handler
    *
    * @details
...
void test_UsageFault_Handler(void)
{
